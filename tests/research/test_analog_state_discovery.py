...
class AnalogStateTests(unittest.TestCase):
    ...
    def test_plan_uses_the_explicit_mission_binding(self)->None:
        eid=next(iter(executable_configuration_map()))
        self.assertEqual(
            build_analog_validation_plan(eid, mission_id="mission-fixture")[
                "mission_id"
            ],
            "mission-fixture",
        )
