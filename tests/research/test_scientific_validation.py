...
class ScientificValidationTests(unittest.TestCase):
    ...
    def test_trend_regime_schema_binds_two_rows_and_540_exposures(self) -> None:
        request, _ = self._request(
            evaluation_schema="trend_regime_evaluation.v1",
    ...
    def test_dense_short_synthesis_schema_binds_two_rows_and_542_exposures(self) -> None:
        request, _ = self._request(
            evaluation_schema="dense_short_synthesis_evaluation.v1",
    ...
    def test_regime_direction_router_schema_binds_two_rows_and_546_exposures(self) -> None:
        request, _ = self._request(
            evaluation_schema="regime_direction_router_evaluation.v1",
    ...
    def test_monthly_loss_lock_risk_schema_binds_two_rows_and_548_exposures(self) -> None:
        request, _ = self._request(
            evaluation_schema="monthly_loss_lock_risk_evaluation.v1",
