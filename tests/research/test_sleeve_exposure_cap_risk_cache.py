...
def test_family_trace_cache_roundtrip_is_producer_bound(tmp_path) -> None:
    ...
    producer = build_sleeve_exposure_cap_risk_job_plan(
    ...
    consumer = build_sleeve_exposure_cap_risk_job_plan(
        repository_root=tmp_path,
        mission_id=MISSION_ID,
        study_id="STU-PAIR-CACHE",
    ...
    rebound = bind_sleeve_exposure_cap_risk_family_trace(
        family,
        definition=definition,
        mission_id=MISSION_ID,
    ...
    producer_trace = bind_sleeve_exposure_cap_risk_family_trace(
        family,
        definition=definition,
        mission_id=MISSION_ID,
    ...
    opened, opened_provenance, opened_trace, _ = (
        verify_sleeve_exposure_cap_risk_cache_producer(
            ...
            expected_callable_identity="synthetic.sleeve_exposure_cap.v1",
        )
    )
