...
class ImportTest(unittest.TestCase):
    ...
    def test_cli_parser_choices_match_registry(self) -> None:
        ...
        self.assertEqual(len(COMMANDS), 1280)
        ...
        self.assertIn("run-c0104-r0001-proxy", choices)
        self.assertIn("run-c0104-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0105-r0001-proxy", choices)
        self.assertIn("run-c0105-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0106-r0001-proxy", choices)
        self.assertIn("run-c0106-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0107-r0001-proxy", choices)
        self.assertIn("run-c0107-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0108-r0001-proxy", choices)
        self.assertIn("run-c0108-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0109-r0001-proxy", choices)
        self.assertIn("run-c0109-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0110-r0001-proxy", choices)
        self.assertIn("run-c0110-r0001-mt5-tick-by-fold", choices)
        ...
        self.assertIn("run-c0049-r0001-proxy", choices)
        self.assertIn("run-c0049-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0052-r0001-proxy", choices)
        self.assertIn("run-c0052-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0053-r0001-proxy", choices)
        self.assertIn("run-c0053-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0054-r0001-proxy", choices)
        self.assertIn("run-c0054-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0055-r0001-proxy", choices)
        self.assertIn("run-c0055-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0056-r0001-proxy", choices)
        self.assertIn("run-c0056-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0057-r0001-proxy", choices)
        self.assertIn("run-c0057-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0058-r0001-proxy", choices)
        self.assertIn("run-c0058-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0059-r0001-proxy", choices)
        self.assertIn("run-c0059-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0060-r0001-proxy", choices)
        self.assertIn("run-c0060-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0061-r0001-proxy", choices)
        self.assertIn("run-c0061-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0062-r0001-proxy", choices)
        self.assertIn("run-c0062-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0063-r0001-proxy", choices)
        self.assertIn("run-c0063-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0064-r0001-proxy", choices)
        self.assertIn("run-c0064-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0065-r0001-proxy", choices)
        self.assertIn("run-c0065-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0066-r0001-proxy", choices)
        self.assertIn("run-c0066-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0067-r0001-proxy", choices)
        self.assertIn("run-c0067-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0068-r0001-proxy", choices)
        self.assertIn("run-c0068-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0069-r0001-proxy", choices)
        self.assertIn("run-c0069-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0070-r0001-proxy", choices)
        self.assertIn("run-c0070-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0071-r0001-proxy", choices)
        self.assertIn("run-c0071-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0072-r0001-proxy", choices)
        self.assertIn("run-c0072-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0073-r0001-proxy", choices)
        self.assertIn("run-c0073-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0074-r0001-proxy", choices)
        self.assertIn("run-c0074-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0075-r0001-proxy", choices)
        self.assertIn("run-c0075-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0076-r0001-proxy", choices)
        self.assertIn("run-c0076-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0077-r0001-proxy", choices)
        self.assertIn("run-c0077-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0078-r0001-proxy", choices)
        self.assertIn("run-c0078-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0079-r0001-proxy", choices)
        ...
        self.assertIn("run-c0082-r0001-proxy", choices)
        self.assertIn("run-c0082-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0082-r0002-proxy", choices)
        self.assertIn("run-c0082-r0002-mt5-tick-by-fold", choices)
        self.assertIn("run-c0083-r0001-proxy", choices)
        self.assertIn("run-c0083-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0084-r0001-proxy", choices)
        self.assertIn("run-c0084-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0085-r0001-proxy", choices)
        self.assertIn("run-c0085-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0086-r0001-proxy", choices)
        self.assertIn("run-c0086-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0087-r0001-proxy", choices)
        self.assertIn("run-c0087-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0088-r0001-proxy", choices)
        self.assertIn("run-c0088-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0089-r0001-proxy", choices)
        self.assertIn("run-c0089-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0090-r0001-proxy", choices)
        self.assertIn("run-c0090-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0091-r0001-proxy", choices)
        self.assertIn("run-c0091-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0092-r0001-proxy", choices)
        self.assertIn("run-c0092-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0093-r0001-proxy", choices)
        self.assertIn("run-c0093-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0094-r0001-proxy", choices)
        self.assertIn("run-c0094-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0095-r0001-proxy", choices)
        self.assertIn("run-c0095-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0096-r0001-proxy", choices)
        self.assertIn("run-c0096-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0097-r0001-proxy", choices)
        self.assertIn("run-c0097-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0098-r0001-proxy", choices)
        self.assertIn("run-c0098-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0099-r0001-proxy", choices)
        self.assertIn("run-c0099-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0100-r0001-proxy", choices)
        self.assertIn("run-c0100-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0101-r0001-proxy", choices)
        self.assertIn("run-c0101-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0102-r0001-proxy", choices)
        self.assertIn("run-c0102-r0001-mt5-tick-by-fold", choices)
        self.assertIn("run-c0103-r0001-proxy", choices)
        self.assertIn("run-c0103-r0001-mt5-tick-by-fold", choices)
