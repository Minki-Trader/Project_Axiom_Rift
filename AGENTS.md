...
3. The active record named by control state, if any
...
- Use `.agents/skills/operate-axiom-mission/SKILL.md` for `/goal`, mission or
  initiative operation, continuation, next action, Job, Repair, blocker,
