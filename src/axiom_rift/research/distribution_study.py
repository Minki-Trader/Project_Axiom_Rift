...
MISSION_ID="MIS-0003";STUDY_ID="STU-0033";CALLABLE_IDENTITY="axiom_rift.research.distribution_study.execute_distribution_job.v2";EVIDENCE_DEPTH="discovery"
...
def _load(w:StateWriter,hashes:tuple[str,...])->tuple[dict[str,Any],str,str]:
    ...
    for h in hashes:
        ...
        if isinstance(v,dict) and v.get("schema")=="distribution_asymmetry_surface.v2":s=(v,h)
