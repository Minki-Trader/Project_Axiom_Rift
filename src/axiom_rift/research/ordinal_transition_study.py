...
MISSION_ID="MIS-0004";STUDY_ID="STU-0042";CALLABLE_IDENTITY="axiom_rift.research.ordinal_transition_study.execute_ordinal_job.v1";EVIDENCE_DEPTH="discovery"
...
def _load(w:StateWriter,hashes:tuple[str,...])->tuple[dict[str,Any],str,str]:
    ...
    for h in hashes:
        ...
        if isinstance(v,dict) and v.get("schema")=="ordinal_transition_surface.v1":s=(v,h)
