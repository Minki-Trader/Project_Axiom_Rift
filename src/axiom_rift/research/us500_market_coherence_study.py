"""Writer-gated evidence Job for the fixed US500 market-coherence router."""
...
CALLABLE_IDENTITY = (
    "axiom_rift.research.us500_market_coherence_study."
    "execute_us500_market_coherence_job.v1"
)
EVIDENCE_DEPTH = "discovery"
_DELTA = "fixed_high_reversal_delta_net_profit_micropoints"
_PVALUE = "fixed_high_reversal_pvalue_upper_ppm"
...
def build_us500_market_coherence_validation_plan(
    executable_id: str,
    *,
    mission_id: str,
) -> dict[str, object]:
...
def surface_output_name(*, study_id: str) -> str:
    return f"scientific/{study_id}/us500-market-coherence-surface.json"


def surface_manifest_output_name(*, study_id: str) -> str:
    return f"scientific/{study_id}/us500-market-coherence-surface-manifest.json"
...
class US500MarketCoherenceJobPacket:
...
def execute_us500_market_coherence_job(
    *,
    ...
    if (
        ...
        raise ValueError("US500 market coherence binding is invalid")
    ...
    if not required.issubset(spec["input_hashes"]):
        raise ValueError("US500 market coherence Job inputs are incomplete")
    surface = compute_registered_us500_market_coherence_surface(root)
    surface_hash = writer.evidence.finalize(canonical_bytes(surface)).sha256
    surface_manifest = {
        "schema": "us500_market_coherence_surface_manifest.v1",
        "surface_artifact_hash": surface_hash,
        "surface_implementation_sha256": us500_market_coherence_discovery_implementation_sha256(),
    }
    ...
    return US500MarketCoherenceJobPacket(
...
__all__ = [
    ...
    "execute_us500_market_coherence_job",
    "output_names",
