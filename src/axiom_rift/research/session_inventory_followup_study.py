...
def build_environment_manifest() -> dict[str, object]:
    if SELECTION_TOTAL_EXPOSURES != 150:
        raise ValueError("session_inventory_followup Study requires global exposure total 150")
    value: dict[str, object] = {
...
def _validate_surface_manifest(
    ...
    *,
    ...
    if (
        ...
        or value.get("selection_total_exposures") != 150
