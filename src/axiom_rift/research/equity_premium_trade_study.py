...
def _load_surface(
    writer: RunningJobExecutionContext, input_hashes: tuple[str, ...],
) -> tuple[dict[str, Any], str, str]:
    binding = read_surface_manifest_evidence_inputs(
        writer.evidence,
        input_hashes,
        surface_schema="equity_premium_trade_surface.v1",
        manifest_schema="equity_premium_trade_surface_manifest.v1",
