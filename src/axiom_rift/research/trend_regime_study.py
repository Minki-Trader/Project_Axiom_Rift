...
def _load_surface(writer:RunningJobExecutionContext,input_hashes:tuple[str,...])->tuple[dict[str,Any],str,str]:
    binding=read_surface_manifest_evidence_inputs(writer.evidence,input_hashes,surface_schema="trend_regime_evaluation_surface.v1",manifest_schema="trend_regime_surface_manifest.v1",expected_surface_implementation_sha256=trend_regime_discovery_implementation_sha256())
