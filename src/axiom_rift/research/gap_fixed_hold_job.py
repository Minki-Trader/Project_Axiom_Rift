"""Thin running-Job adapter for prospective gap fixed-hold research."""
...
import axiom_rift.research.gap_fixed_hold as replay_module
...
CALLABLE_IDENTITY = (
    ...
    "execute_gap_fixed_hold_job.v1"
)
JOB_IMPLEMENTATION_PROTOCOL = "python.source.gap_fixed_hold.v1"
ARTIFACT_NAMESPACE = "gap-fixed-hold-v1"
...
def _definition(
    ...
    return gap_fixed_hold_protocol_definition(context)
...
def _trace(
    ...
    return compute_gap_fixed_hold_family_trace(repository_root, definition)
...
def gap_fixed_hold_job_implementation_artifact() -> bytes:
    return fixed_hold_replay_job_implementation_artifact(RUNTIME_ADAPTER)


def gap_fixed_hold_job_implementation_sha256() -> str:
    return fixed_hold_replay_job_implementation_sha256(RUNTIME_ADAPTER)


def materialize_gap_fixed_hold_job_implementation(
...
def materialize_gap_fixed_hold_running_job_repair_proof(
    ...
    *,
    ...
    return materialize_running_job_implementation_repair_proof(
        ...
        adapter=RUNTIME_ADAPTER,
        explanation=(
            "repair the prospective gap fixed-hold implementation without "
...
def build_gap_fixed_hold_job_plan(
    *,
    mission_id: str,
    study_id: str,
    executable_id: str,
...
def execute_gap_fixed_hold_job(
    *,
...
__all__ = [
    ...
    "materialize_gap_fixed_hold_running_job_repair_proof",
]
