...
MISSION_ID="MIS-0004";STUDY_ID="STU-0050";CALLABLE_IDENTITY="axiom_rift.research.volatility_duration_study.execute_volatility_duration_job.v1";EVIDENCE_DEPTH="discovery"
...
def _load(w:StateWriter,hashes:tuple[str,...])->tuple[dict[str,Any],str,str]:
    ...
    for h in hashes:
        ...
        if isinstance(v,dict) and v.get("schema")=="volatility_duration_surface.v1":s=(v,h)
