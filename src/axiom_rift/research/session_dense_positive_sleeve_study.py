...
def _load(writer: RunningJobExecutionContext, inputs: tuple[str, ...]) -> tuple[dict[str, Any], str, str]:
    binding = read_surface_manifest_evidence_inputs(
        writer.evidence,
        inputs,
        surface_schema="session_dense_positive_sleeve_surface.v1",
        manifest_schema="session_dense_positive_sleeve_surface_manifest.v1",
