...
MISSION_ID="MIS-0003";STUDY_ID="STU-0035";CALLABLE_IDENTITY="axiom_rift.research.candle_geometry_study.execute_candle_job.v2";EVIDENCE_DEPTH="discovery"
...
def _load(w:StateWriter,hashes:tuple[str,...])->tuple[dict[str,Any],str,str]:
    ...
    for h in hashes:
        ...
        if isinstance(v,dict) and v.get("schema")=="candle_geometry_surface.v2":s=(v,h)
