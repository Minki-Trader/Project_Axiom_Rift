...
MISSION_ID="MIS-0003";STUDY_ID="STU-0037";CALLABLE_IDENTITY="axiom_rift.research.liquidity_supply_study.execute_liquidity_job.v2";EVIDENCE_DEPTH="discovery"
...
def _load(w:StateWriter,hashes:tuple[str,...])->tuple[dict[str,Any],str,str]:
    ...
    for h in hashes:
        ...
        if isinstance(v,dict) and v.get("schema")=="liquidity_supply_surface.v2":s=(v,h)
