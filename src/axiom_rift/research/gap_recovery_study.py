...
MISSION_ID="MIS-0004";STUDY_ID="STU-0046";CALLABLE_IDENTITY="axiom_rift.research.gap_recovery_study.execute_gap_job.v3";EVIDENCE_DEPTH="discovery"
...
def _load(w:StateWriter,hashes:tuple[str,...])->tuple[dict[str,Any],str,str]:
    ...
    for h in hashes:
        ...
        if isinstance(v,dict) and v.get("schema")=="gap_recovery_surface.v3":s=(v,h)
