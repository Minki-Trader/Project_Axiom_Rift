"""Writer-gated evidence Job for the causal long-high vol dense regime contrast."""
...
from axiom_rift.research.high_vol_dense_regime_discovery import compute_registered_high_vol_dense_regime_surface,project_high_vol_dense_regime_evaluation,high_vol_dense_regime_discovery_implementation_sha256
...
CALLABLE_IDENTITY="axiom_rift.research.high_vol_dense_regime_study.execute_high_vol_dense_regime_job.v1"
...
def build_high_vol_dense_regime_validation_plan(executable_id:str,*,mission_id:str)->dict[str,object]:
...
def execute_high_vol_dense_regime_job(*,repository_root:str|Path,execution:RunningJobExecution)->HighVolDenseRegimeJobPacket:
    ...
    if not required.issubset(inputs):raise ValueError("high vol dense regime inputs are missing")
