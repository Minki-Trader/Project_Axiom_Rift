...
FIXED_HOLD_COST_AWARE_PROPOSAL_ORIGIN_NEW_IMPLEMENTATION_IDENTITY = (
    "6d4a5384bab5485f624b53f3e110fb69a2bd073c4621b1bcd91b76c7ec5104ea"
)
...
_COST_AWARE_CROSS_STUDY_ORIGIN_JOB_SOURCE_PATHS = tuple(
    sorted(
        ...
        | {
            ...
            "axiom_rift/research/cost_aware_execution_family_inference.py",
            "axiom_rift/research/cost_aware_execution_protocol.py",
            "axiom_rift/research/cost_aware_execution_shared_contract.py",
            "axiom_rift/research/cost_aware_execution_shared_trace.py",
            "axiom_rift/research/cost_aware_execution_trace.py",
            "axiom_rift/research/cost_aware_execution_trace_snapshot.py",
