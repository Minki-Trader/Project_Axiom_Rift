"""SC0006 SR0001 proxy for post-C0030 negative-memory synthesis."""
...
WORK_UNIT_ID = "SC0006"
RUN_ID = "SR0001"
WORK_UNIT_DIR = PROJECT_ROOT / "campaigns" / "SC0006_post_c0030_negative_memory_synthesis"
RUN_DIR = WORK_UNIT_DIR / "runs" / RUN_ID
PROXY_PATH = RUN_DIR / "kpi" / "proxy.json"
TRADE_ARTIFACT_PATH = RUN_DIR / "artifacts" / "sc0006_sr0001_proxy_trades.csv"
SUMMARY_ARTIFACT_PATH = RUN_DIR / "artifacts" / "sc0006_sr0001_negative_memory_synthesis_summary.json"
...
MODEL_FAMILY = "fold_local_post_c0030_negative_memory_conflict_synthesis"
...
FOLD_LOSS_DENSITY_PENALTY_WEIGHT = 0.08
RECENT_NEGATIVE_MEMORY_PRESSURE_WEIGHT = 0.06

SOURCE_INGREDIENTS = (
    (
        "C0023",
        "c0023_ig001_tick_participation_pressure_negative_memory",
        "campaigns/C0023_tick_participation_pressure_discovery/runs/R0001/artifacts/c0023_r0001_proxy_trades.csv",
    ),
    (
        "C0024",
        "c0024_ig001_calendar_phase_rhythm_negative_memory",
        "campaigns/C0024_calendar_phase_rhythm_discovery/runs/R0001/artifacts/c0024_r0001_proxy_trades.csv",
    ),
    (
        "C0025",
        "c0025_ig001_range_overlap_topology_negative_memory",
        "campaigns/C0025_range_overlap_topology_discovery/runs/R0001/artifacts/c0025_r0001_proxy_trades.csv",
    ),
    (
        "C0026",
        "c0026_ig001_price_acceleration_curvature_negative_memory",
        "campaigns/C0026_price_acceleration_curvature_discovery/runs/R0001/artifacts/c0026_r0001_proxy_trades.csv",
    ),
    (
        "C0027",
        "c0027_ig001_symbolic_microstructure_grammar_negative_memory",
        "campaigns/C0027_symbolic_microstructure_grammar_discovery/runs/R0001/artifacts/c0027_r0001_proxy_trades.csv",
    ),
    (
        "C0028",
        "c0028_ig001_intraday_swing_leg_maturity_negative_memory",
        "campaigns/C0028_intraday_swing_leg_maturity_discovery/runs/R0001/artifacts/c0028_r0001_proxy_trades.csv",
    ),
    (
        "C0029",
        "c0029_ig001_intraday_fractal_pivot_transition_negative_memory",
        "campaigns/C0029_intraday_fractal_pivot_transition_discovery/runs/R0001/artifacts/c0029_r0001_proxy_trades.csv",
    ),
    (
        "C0030",
        "c0030_ig001_intraday_vwap_repricing_pressure_negative_memory",
...
SOURCE_MEMORY_PRESSURE = {
    "C0023": {"fold_loss_density": 1.0, "recent_negative_memory_pressure": 0.125},
    "C0024": {"fold_loss_density": 8.0 / 9.0, "recent_negative_memory_pressure": 0.250},
    "C0025": {"fold_loss_density": 1.0, "recent_negative_memory_pressure": 0.375},
    "C0026": {"fold_loss_density": 1.0, "recent_negative_memory_pressure": 0.500},
    "C0027": {"fold_loss_density": 1.0, "recent_negative_memory_pressure": 0.625},
    "C0028": {"fold_loss_density": 1.0, "recent_negative_memory_pressure": 0.750},
    "C0029": {"fold_loss_density": 1.0, "recent_negative_memory_pressure": 0.875},
    "C0030": {"fold_loss_density": 1.0, "recent_negative_memory_pressure": 1.000},
}
...
def run_sc0006_sr0001_proxy(write: bool = True) -> dict[str, object]:
...
def load_source_candidates() -> list[SourceCandidate]:
    ...
    for row in raw_rows:
        ...
        memory = SOURCE_MEMORY_PRESSURE[str(row["source_id"])]
        candidates.append(
            SourceCandidate(
                ...
                spread_points=float(row["spread_points"]),
                fold_loss_density=float(memory["fold_loss_density"]),
                recent_negative_memory_pressure=float(memory["recent_negative_memory_pressure"]),
            )
        )
    return candidates
...
def synthesize_fold_candidates(source_candidates: list[SourceCandidate]) -> list[base.Candidate]:
    ...
    for candidate in source_candidates:
        ...
        fold_loss_density = candidate.fold_loss_density
        recent_pressure = candidate.recent_negative_memory_pressure
        score = (
        ...
        synthesized.append(
            base.Candidate(
                ...
                state_key=(
                    f"{side}|post_c0030_negative_memory|{candidate.source_id.lower()}|same_{same_count}|"
                    f"opp_{opposite_count}|loss_{int(round(100.0 * fold_loss_density))}|"
                    f"recent_{int(round(100.0 * recent_pressure))}"
                ),
                features=(
...
def synthesis_distribution(
    ...
    recent_pressure_values = [candidate.features[6] for candidate in synthesized]
    return {
        ...
        "recent_negative_memory_pressure_p50": base.rounded(base.percentile(recent_pressure_values, 0.50)),
    }
...
def build_proxy_payload(
    ...
    payload["proxy_id"] = "PX-SC0006-SR0001"
    payload["proxy_engine"] = "axiom_rift.proxies.sc0006_sr0001_post_c0030_negative_memory_synthesis"
    payload["proxy_config_path"] = "campaigns/SC0006_post_c0030_negative_memory_synthesis/runs/SR0001/run_manifest.json"
    ...
    payload["proxy_artifact_paths"] = [
        "campaigns/SC0006_post_c0030_negative_memory_synthesis/runs/SR0001/kpi/proxy.json",
        "campaigns/SC0006_post_c0030_negative_memory_synthesis/runs/SR0001/artifacts/sc0006_sr0001_proxy_trades.csv",
        "campaigns/SC0006_post_c0030_negative_memory_synthesis/runs/SR0001/artifacts/sc0006_sr0001_negative_memory_synthesis_summary.json",
    ]
    ...
    profiles["negative_memory_synthesis_profile"] = {  # type: ignore[index]
        ...
        "fields": {
            ...
            "fold_loss_density_penalty_weight": FOLD_LOSS_DENSITY_PENALTY_WEIGHT,
            "recent_negative_memory_pressure_weight": RECENT_NEGATIVE_MEMORY_PRESSURE_WEIGHT,
    ...
    profiles["mt5_pairing_profile"] = {  # type: ignore[index]
        ...
        "fields": {
            ...
            "next_action": "produce_sc0006_sr0001_mt5_logic_parity_evidence",
        },
    }
    return payload
    ...
    config.update(
        {
            ...
            "weights": {
                ...
                "recent_negative_memory_pressure": RECENT_NEGATIVE_MEMORY_PRESSURE_WEIGHT,
            },
            "variant_boundary": "post_c0030_negative_memory_conflict_synthesis_not_c0030_threshold_score_stop_target_hold_activity_spread_session_or_retry_nudge",
...
def write_summary_artifact(payload: dict[str, object], path: Path) -> None:
    profiles = payload["conditional_profiles"]  # type: ignore[index]
    summary = {
        "schema": "axiom_rift_post_c0030_negative_memory_synthesis_summary_v1",
        "template": False,
        ...
        [
            artifact_record(
                ...
                [
                    ...
                    "campaigns/SC0006_post_c0030_negative_memory_synthesis/ingredient_refs.yaml",
                    "campaigns/SC0006_post_c0030_negative_memory_synthesis/synthesis_queue.yaml",
                    "campaigns/SC0006_post_c0030_negative_memory_synthesis/runs/SR0001/run_manifest.json",
                ],
            ),
            artifact_record(
                "A-SC0006-SR0001-PROXY-TRADES",
            ...
            artifact_record(
                "A-SC0006-SR0001-NEGATIVE-MEMORY-SYNTHESIS-SUMMARY",
...
def artifact_record(
    ...
    return {
        ...
        "sha256": digest,
        "produced_by": "axiom_rift.proxies.sc0006_sr0001_post_c0030_negative_memory_synthesis",
...
def update_run_manifest_status() -> None:
    ...
    evidence["proxy_trade_artifact"] = "artifacts/sc0006_sr0001_proxy_trades.csv"
    evidence["negative_memory_synthesis_summary"] = "artifacts/sc0006_sr0001_negative_memory_synthesis_summary.json"
...
def update_gate_report() -> None:
    ...
    data["next_action"] = "produce_sc0006_sr0001_mt5_logic_parity_evidence"
    evidence_paths = list(data.get("evidence_paths") or [])
    for path in (
        "artifacts/sc0006_sr0001_proxy_trades.csv",
        "artifacts/sc0006_sr0001_negative_memory_synthesis_summary.json",
        "kpi/proxy.json",
    ):
    ...
    data["deferred_with_reason"] = [
        {
            ...
            "revisit_when": "produce_sc0006_sr0001_mt5_logic_parity_evidence",
        }
    ]
...
def update_synthesis_status() -> None:
    ...
    next_candidate["direction"] = "active_sc0006_sr0001_mt5_logic_parity"
...
def update_synthesis_queue_after_proxy() -> None:
    ...
    for item in data.get("queue", []):
        if item.get("synthesis_run_id") == RUN_ID:
            ...
            item["last_completed_step"] = "produce_sc0006_sr0001_proxy_evidence"
            item["next_action"] = "produce_sc0006_sr0001_mt5_logic_parity_evidence"
...
def update_reentry_after_proxy() -> None:
    ...
    data.setdefault("project", {})["active_synthesis"] = "campaigns/SC0006_post_c0030_negative_memory_synthesis"
    next_work = data.setdefault("next_work", {})
    next_work["synthesis"] = "campaigns/SC0006_post_c0030_negative_memory_synthesis"
    completed = list(next_work.get("completed") or [])
    for item in (
        "open_sc0006_post_c0030_negative_memory_synthesis",
        "open_sc0006_sr0001_post_c0030_negative_memory_synthesis_run",
        "produce_sc0006_sr0001_proxy_evidence",
    ):
    ...
    data["active_synthesis"] = "campaigns/SC0006_post_c0030_negative_memory_synthesis"
    data["active_run"] = "campaigns/SC0006_post_c0030_negative_memory_synthesis/runs/SR0001"
...
def update_claim_state_after_proxy(payload: dict[str, object]) -> None:
    ...
    data["latest_operation"] = {
        "id": "produce_sc0006_sr0001_proxy_evidence",
        "status": "completed",
        "recorded_at_source": "campaigns/SC0006_post_c0030_negative_memory_synthesis/runs/SR0001/kpi/proxy.json",
        "evidence_status": "proxy_recorded_pending_mt5",
        "active_synthesis": "campaigns/SC0006_post_c0030_negative_memory_synthesis",
        "active_run": "campaigns/SC0006_post_c0030_negative_memory_synthesis/runs/SR0001",
        ...
        "next_required_action": "produce_sc0006_sr0001_mt5_logic_parity_evidence",
...
def update_decision_cursor_after_proxy(payload: dict[str, object]) -> None:
    ...
    summary = payload.get("proxy_summary", {})
    required = payload.get("required_kpis", {})
    data["canonical_source"] = "campaigns/SC0006_post_c0030_negative_memory_synthesis/runs/SR0001/kpi/proxy.json"
    data["canonical_status"] = "proxy_recorded_pending_mt5"
    data["current_decision"] = "produce_sc0006_sr0001_mt5_logic_parity_evidence"
    data["active_synthesis"] = "campaigns/SC0006_post_c0030_negative_memory_synthesis"
    data["active_run"] = "campaigns/SC0006_post_c0030_negative_memory_synthesis/runs/SR0001"
    data["next_required_action"] = "produce_sc0006_sr0001_mt5_logic_parity_evidence"
    current = data.setdefault("current_evidence_summary", {})
    current.update(
        {
            "source_campaign": None,
            "source_synthesis": "campaigns/SC0006_post_c0030_negative_memory_synthesis",
            "current_task": "produce_sc0006_sr0001_mt5_logic_parity_evidence",
            "active_run": "campaigns/SC0006_post_c0030_negative_memory_synthesis/runs/SR0001",
            ...
            "trade_logic_surface": "fixed_lot_dual_direction_post_c0030_negative_memory_conflict_schedule",
            "entries_per_active_day": summary.get("entries_per_active_day") if isinstance(summary, dict) else None,
            "proxy_net_pnl_points": required.get("proxy_net_pnl_points") if isinstance(required, dict) else None,
            "proxy_profit_factor": required.get("proxy_profit_factor") if isinstance(required, dict) else None,
            "proxy_trade_count": required.get("proxy_trade_count") if isinstance(required, dict) else None,
            "note": "SC0006 SR0001 proxy is recorded; MT5 paired validation is mandatory before judgment.",
        }
    )
...
def replace_base_markers(value: Any) -> Any:
    ...
    if isinstance(value, str):
        replacements = {
            "C0004 R0001": "SC0006 SR0001",
            "C0004": "SC0006",
            "R0001": "SR0001",
            "c0004_r0001_fold_local_state_archetype": "sc0006_sr0001_post_c0030_negative_memory_synthesis",
            "c0004_r0001": "sc0006_sr0001",
            "fold_local_state_archetype_discovery": "post_c0030_negative_memory_synthesis",
...
if __name__ == "__main__":
    print(json.dumps(run_sc0006_sr0001_proxy(write=True), indent=2, sort_keys=True))
