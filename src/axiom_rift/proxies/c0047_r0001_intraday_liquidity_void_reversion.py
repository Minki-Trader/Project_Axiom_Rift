"""C0047 R0001 proxy evidence for intraday liquidity void reversion discovery."""
...
RUN_DIR = PROJECT_ROOT / "campaigns" / "C0047_intraday_liquidity_void_reversion_discovery" / "runs" / "R0001"
...
TRADE_ARTIFACT_PATH = RUN_DIR / "artifacts" / "c0047_r0001_proxy_trades.csv"
LIQUIDITY_VOID_REVERSION_SUMMARY_PATH = RUN_DIR / "artifacts" / "c0047_r0001_liquidity_void_reversion_summary.json"
...
FEATURE_NAMES = (
    ...
    "opposing_displacement_3",
    "opposing_displacement_6",
    "directional_fill_return_1",
    "directional_fill_return_3",
    "void_gap_3",
    "void_gap_6",
    "low_overlap_3",
    "low_overlap_6",
    ...
    "body_imbalance_6",
    "body_imbalance_12",
    "opposing_void_energy_6",
    "opposing_void_energy_12",
    "directional_void_rejection_3",
    "directional_void_rejection_6",
    "fill_pressure_3",
    "fill_pressure_6",
    "fill_pressure_12",
    "void_age_pressure_12",
    "void_decay_pressure_24",
    ...
    "spread_over_range",
    "spread_void_stress",
    "fill_to_spread_margin",
    "void_cost_buffer",
    "late_session_void_pressure",
    "wick_fill_fragility",
    "adverse_churn_pressure",
    "quantized_fill_margin",
    "fill_survival_interaction",
    "void_fill_alignment",
    "void_rejection_interaction",
    "void_energy_interaction",
)
MODEL_FAMILY = "fold_local_intraday_liquidity_void_fill_rejection_rank"
LABEL_SHAPE = "directional_intraday_liquidity_void_fill_rejection_quality"
POSITIVE_LABEL_THRESHOLD = 0.18
ADVERSE_LABEL_THRESHOLD = -0.36
FEATURE_WEIGHT_FLOOR = 0.25
FEATURE_WEIGHT_CEILING = 2.50
SELECTION_RULE = "top_fold_local_intraday_liquidity_void_fill_rejection_scores_per_active_day"
...
def run_c0047_r0001_proxy(write: bool = True) -> dict[str, object]:
...
def build_proxy_payload(
    ...
    payload["proxy_id"] = "PX-C0047-R0001"
    payload["proxy_engine"] = "axiom_rift.proxies.c0047_r0001_intraday_liquidity_void_reversion"
    payload["proxy_config_path"] = "campaigns/C0047_intraday_liquidity_void_reversion_discovery/runs/R0001/run_manifest.json"
    ...
    payload["proxy_artifact_paths"] = [
        "campaigns/C0047_intraday_liquidity_void_reversion_discovery/runs/R0001/kpi/proxy.json",
        "campaigns/C0047_intraday_liquidity_void_reversion_discovery/runs/R0001/artifacts/c0047_r0001_proxy_trades.csv",
        "campaigns/C0047_intraday_liquidity_void_reversion_discovery/runs/R0001/artifacts/c0047_r0001_liquidity_void_reversion_summary.json",
    ]
    ...
    profiles["mt5_pairing_profile"] = {  # type: ignore[index]
        ...
        "fields": {
            ...
            "next_action": "produce_c0047_r0001_mt5_logic_parity_evidence",
        },
    }
    return payload
        ...
        [
            artifact_record(
                ...
                [
                    ...
                    "campaigns/C0047_intraday_liquidity_void_reversion_discovery/runs/R0001/run_manifest.json",
                ],
            ),
            artifact_record(
                "A-C0047-R0001-PROXY-TRADES",
            ...
            artifact_record(
                "A-C0047-R0001-LIQUIDITY-VOID-REVERSION-SUMMARY",
...
def artifact_record(
    ...
    return {
        ...
        "sha256": digest,
        "produced_by": "axiom_rift.proxies.c0047_r0001_intraday_liquidity_void_reversion",
...
def update_run_manifest_status() -> None:
    ...
    evidence["proxy_trade_artifact"] = "artifacts/c0047_r0001_proxy_trades.csv"
    evidence["intraday_liquidity_void_reversion_summary"] = "artifacts/c0047_r0001_liquidity_void_reversion_summary.json"
...
def update_gate_report() -> None:
    ...
    data["next_action"] = "produce_c0047_r0001_mt5_logic_parity_evidence"
    evidence_paths = list(data.get("evidence_paths") or [])
    for path in (
        "artifacts/c0047_r0001_proxy_trades.csv",
        "artifacts/c0047_r0001_liquidity_void_reversion_summary.json",
        "kpi/proxy.json",
    ):
    ...
    data["deferred_with_reason"] = [
        {
            ...
            "revisit_when": "after C0047 R0001 MT5 evidence files contain measured results",
        }
    ]
...
def update_campaign_status() -> None:
    ...
    next_candidate["direction"] = "active_c0047_r0001_mt5_logic_parity"
    ...
    closeout["remaining_question"] = "produce_c0047_r0001_mt5_logic_parity_evidence"
...
def update_reentry_after_proxy() -> None:
    ...
    data["project"]["active_run"] = "campaigns/C0047_intraday_liquidity_void_reversion_discovery/runs/R0001"
    ...
    for item in (
        ...
        "open_c0047_r0001_intraday_liquidity_void_reversion_fill_rejection_run",
        "produce_c0047_r0001_proxy_evidence",
    ):
    ...
    data["active_run"] = "campaigns/C0047_intraday_liquidity_void_reversion_discovery/runs/R0001"
...
def update_claim_state_after_proxy(payload: dict[str, object]) -> None:
    ...
    data["latest_operation"] = {
        "id": "produce_c0047_r0001_proxy_evidence",
        "status": "completed",
        "recorded_at_source": "campaigns/C0047_intraday_liquidity_void_reversion_discovery/runs/R0001/kpi/proxy.json",
        ...
        "next_required_action": "produce_c0047_r0001_mt5_logic_parity_evidence",
...
def update_decision_cursor_after_proxy(payload: dict[str, object]) -> None:
    ...
    data["canonical_source"] = "campaigns/C0047_intraday_liquidity_void_reversion_discovery/runs/R0001/kpi/proxy.json"
    data["canonical_status"] = "proxy_recorded_pending_mt5"
    data["current_decision"] = "produce_c0047_r0001_mt5_logic_parity_evidence"
    data["active_campaign"] = "campaigns/C0047_intraday_liquidity_void_reversion_discovery"
    data["active_run"] = "campaigns/C0047_intraday_liquidity_void_reversion_discovery/runs/R0001"
    data["next_required_action"] = "produce_c0047_r0001_mt5_logic_parity_evidence"
    data["current_evidence_summary"] = {
        "source_campaign": "campaigns/C0047_intraday_liquidity_void_reversion_discovery",
        "current_task": "produce_c0047_r0001_mt5_logic_parity_evidence",
        "active_run": "campaigns/C0047_intraday_liquidity_void_reversion_discovery/runs/R0001",
        ...
        "proxy_profit_factor": required.get("proxy_profit_factor") if isinstance(required, dict) else None,
        "next_required_action": "produce_c0047_r0001_mt5_logic_parity_evidence",
        "note": "C0047 R0001 proxy evidence recorded; MT5 paired validation remains mandatory regardless of proxy result.",
...
def replace_run_markers(value: Any) -> Any:
    ...
    if isinstance(value, str):
        replacements = {
            "C0004": "C0047",
            "c0004_r0002_fold_local_state_archetype": "c0047_r0001_intraday_liquidity_void_reversion",
            "c0004_r0002": "c0047_r0001",
...
def _c0047_low_overlap_pressure(
    bars: list[base.Bar],
    index: int,
    direction: int,
    lookback: int,
    ...
    for cursor in range(start, index + 1):
        ...
        opposing_body = max(0.0, -direction * (bar.close - bar.open) / current_range)
        weighted_gap += low_overlap * (0.35 + opposing_body)
        weight += 1.0
    return weighted_gap / max(weight, 1.0)


def _c0047_body_imbalance(
    bars: list[base.Bar],
    index: int,
    direction: int,
    lookback: int,
...
def _c0047_final_void_features(
    bars: list[base.Bar],
    range_average: list[float | None],
    short_range_average: list[float | None],
    day_context: list[dict[str, float] | None],
    ...
    opposing_displacement_3 = max(0.0, -directional_ret_3)
    opposing_displacement_6 = max(0.0, -directional_ret_6)
    fill_return_1 = max(0.0, directional_ret_1)
    fill_return_3 = max(0.0, directional_ret_3)
    void_gap_3 = _c0047_recent_void_gap(bars, index, direction, 3, average_range)
    void_gap_6 = _c0047_recent_void_gap(bars, index, direction, 6, average_range)
    low_overlap_3 = _c0047_low_overlap_pressure(bars, index, direction, 3)
    low_overlap_6 = _c0047_low_overlap_pressure(bars, index, direction, 6)
    low_overlap_12 = _c0047_low_overlap_pressure(bars, index, direction, 12)
    body_imbalance_3 = _c0047_body_imbalance(bars, index, direction, 3)
    body_imbalance_6 = _c0047_body_imbalance(bars, index, direction, 6)
    body_imbalance_12 = _c0047_body_imbalance(bars, index, direction, 12)
    opposing_void_energy_6 = opposing_displacement_6 * (0.5 + low_overlap_6 + body_imbalance_6)
    opposing_void_energy_12 = max(0.0, -direction * context["ret_12"]) * (
        0.5 + low_overlap_12 + body_imbalance_12
    )
    rejection_3 = fill_return_3 * (0.5 + void_gap_3 + low_overlap_3)
    rejection_6 = max(0.0, directional_ret_6 + 0.35 * fill_return_3) * (0.5 + void_gap_6 + low_overlap_6)
    fill_pressure_3 = opposing_displacement_3 * (0.5 + void_gap_3 + low_overlap_3 + body_imbalance_3)
    fill_pressure_6 = opposing_displacement_6 * (0.5 + void_gap_6 + low_overlap_6 + body_imbalance_6)
    fill_pressure_12 = max(0.0, -direction * context["ret_12"]) * (
        0.5 + low_overlap_12 + body_imbalance_12
    )
    void_age_pressure = 0.55 * fill_pressure_12 + 0.30 * fill_pressure_6 - 0.20 * fill_return_3
    ...
    day_mid_pressure = direction * (context["day_mid"] - bars[index].close) / average_range
    favorable_wick = favorable_wick_acceptance(bars, index, direction, 6, average_range)
    opposing_wick = opposing_wick_rejection(bars, index, direction, 6, average_range)
    path_efficiency = directional_path_efficiency(bars, index, direction, 12)
    path_churn = flow_path_churn_ratio(bars, index, 12)
    void_fill_alignment = (
        0.35 * fill_pressure_6
        + 0.28 * rejection_3
        + 0.18 * favorable_wick
        + 0.12 * max(0.0, day_mid_pressure)
        - 0.25 * opposing_wick
    )
    void_rejection_interaction = rejection_6 * (0.5 + low_overlap_6) - 0.35 * fill_pressure_12
    void_energy_interaction = (fill_pressure_6 + rejection_3) * (
        0.5 + context["energy_6"] + 0.25 * context["range_expansion_6_24"]
    )
    spread_void_stress = spread_over_range * (1.0 + fill_pressure_6 + low_overlap_6 + body_imbalance_6)
    fill_to_spread_margin = fill_return_3 + 0.45 * fill_pressure_6 - 2.0 * spread_over_range
    void_cost_buffer = max(0.0, fill_to_spread_margin + 0.30 * void_fill_alignment - spread_void_stress)
    late_session_void_pressure = context["session_progress"] * spread_void_stress
    wick_fill_fragility = max(0.0, opposing_wick - favorable_wick) + spread_over_range * (1.0 + path_churn)
    adverse_churn_pressure = path_churn * (1.0 + fill_pressure_12 + opposing_void_energy_12) + max(
        0.0, -path_efficiency
    )
    quantized_fill_margin = math.trunc((void_fill_alignment - spread_void_stress) * 50.0) / 50.0
    fill_survival_interaction = (
        (void_fill_alignment + 0.25 * void_rejection_interaction - spread_void_stress) * (0.5 + fill_return_3)
        - 0.25 * wick_fill_fragility
    )
    features = (
        float(direction),
        directional_ret_1,
...
def _c0047_final_void_label(
    ...
    favorable_body_share = sum(1 for bar in path if direction * (bar.close - bar.open) > 0.0) / len(path)
    opposing_close_share = sum(1 for bar in path if direction * (bar.close - entry) < -0.22 * average_range) / len(path)
    pre_void = max(0.0, -direction * context["ret_6"])
    pre_fill = max(0.0, direction * context["ret_3"])
    pre_gap = _c0047_recent_void_gap(bars, index, direction, 6, average_range)
    pre_overlap = _c0047_low_overlap_pressure(bars, index, direction, 6)
    fill_completion = min(2.5, favorable + max(0.0, terminal_norm) + 0.35 * first_hit)
    void_state_reward = pre_void * (0.5 + pre_gap + pre_overlap)
    spread_norm = bars[entry_index].spread_points / average_range
    path_spread_peak = max(bar.spread_points for bar in path) / average_range
    churn = future_path_churn(path, entry)
    spread_spike = max(0.0, path_spread_peak - spread_norm)
    survival_buffer = max(0.0, early_followthrough + 0.35 * favorable + 0.25 * pre_fill - spread_norm - 0.50 * path_spread_peak)
    adverse_cost_drag = spread_norm + 0.80 * path_spread_peak + 0.25 * context["session_progress"] * path_spread_peak
    ambiguous_exit_drag = max(0.0, early_adverse + churn - early_followthrough)
    return (
        0.86 * first_hit
...
build_liquidity_void_reversion_context = _c0047_final_void_context
intraday_liquidity_void_reversion_features = _c0047_final_void_features
intraday_liquidity_void_reversion_label = _c0047_final_void_label
