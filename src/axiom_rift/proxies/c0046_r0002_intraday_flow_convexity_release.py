"""C0046 R0002 proxy evidence for intraday flow convexity release discovery."""
...
RUN_DIR = PROJECT_ROOT / "campaigns" / "C0046_intraday_flow_convexity_release_discovery" / "runs" / "R0002"
...
TRADE_ARTIFACT_PATH = RUN_DIR / "artifacts" / "c0046_r0002_proxy_trades.csv"
FLOW_CONVEXITY_RELEASE_SUMMARY_PATH = RUN_DIR / "artifacts" / "c0046_r0002_flow_convexity_release_summary.json"
...
MODEL_FAMILY = "fold_local_intraday_flow_convexity_release_fragility_survival_rank"
LABEL_SHAPE = "directional_intraday_signed_flow_convexity_release_fragility_survival_quality"
POSITIVE_LABEL_THRESHOLD = 0.18
ADVERSE_LABEL_THRESHOLD = -0.36
FEATURE_WEIGHT_FLOOR = 0.25
FEATURE_WEIGHT_CEILING = 2.50
SELECTION_RULE = "top_fold_local_intraday_flow_convexity_release_fragility_survival_scores_per_active_day"
...
def run_c0046_r0002_proxy(write: bool = True) -> dict[str, object]:
...
def linear_model_summary(model: LinearEdgeModel) -> dict[str, object]:
    return {
        ...
        "score_interpretation": "higher_score_means_fold_local_intraday_flow_convexity_release_fragility_survival_rank",
    }
...
def build_proxy_payload(
    ...
    payload["proxy_id"] = "PX-C0046-R0002"
    payload["proxy_engine"] = "axiom_rift.proxies.c0046_r0002_intraday_flow_convexity_release"
    payload["proxy_config_path"] = "campaigns/C0046_intraday_flow_convexity_release_discovery/runs/R0002/run_manifest.json"
    payload["split_policy"] = "rolling_window_test_oos_only_with_train_is_intraday_flow_convexity_release_fragility_survival_rank_fit"
    payload["claim_boundary"] = dict(CLAIM_BOUNDARY)
    payload["proxy_artifact_paths"] = [
        "campaigns/C0046_intraday_flow_convexity_release_discovery/runs/R0002/kpi/proxy.json",
        "campaigns/C0046_intraday_flow_convexity_release_discovery/runs/R0002/artifacts/c0046_r0002_proxy_trades.csv",
        "campaigns/C0046_intraday_flow_convexity_release_discovery/runs/R0002/artifacts/c0046_r0002_flow_convexity_release_summary.json",
    ]
    ...
    profiles["intraday_flow_convexity_release_profile"] = {  # type: ignore[index]
        ...
        "fields": {
            ...
            "candidate_direction": "dual_direction_long_and_short_cost_fragility_survival_per_closed_bar",
            "model_selected": False,
            "feature_set_selected": False,
            "label_selected": False,
        },
    ...
    profiles["mt5_pairing_profile"] = {  # type: ignore[index]
        ...
        "fields": {
            ...
            "next_action": "produce_c0046_r0002_mt5_logic_parity_evidence",
        },
    }
    return payload
    ...
    config.update(
        {
            ...
            "score_interpretation": "higher_score_means_fold_local_intraday_flow_convexity_release_fragility_survival_rank",
            "variant_boundary": (
                "intraday_flow_convexity_release_fragility_survival_rank_changes_feature_label_model_and_scoring_surface_"
        ...
        [
            artifact_record(
                ...
                [
                    ...
                    "campaigns/C0046_intraday_flow_convexity_release_discovery/runs/R0002/run_manifest.json",
                ],
            ),
            artifact_record(
                "A-C0046-R0002-PROXY-TRADES",
            ...
            artifact_record(
                "A-C0046-R0002-FLOW-CONVEXITY-FRAGILITY-SURVIVAL-SUMMARY",
...
def artifact_record(
    ...
    return {
        ...
        "sha256": digest,
        "produced_by": "axiom_rift.proxies.c0046_r0002_intraday_flow_convexity_release",
...
def update_run_manifest_status() -> None:
    ...
    evidence["proxy_trade_artifact"] = "artifacts/c0046_r0002_proxy_trades.csv"
    evidence["intraday_flow_convexity_release_summary"] = "artifacts/c0046_r0002_flow_convexity_release_summary.json"
...
def update_gate_report() -> None:
    ...
    data["next_action"] = "produce_c0046_r0002_mt5_logic_parity_evidence"
    evidence_paths = list(data.get("evidence_paths") or [])
    for path in (
        "artifacts/c0046_r0002_proxy_trades.csv",
        "artifacts/c0046_r0002_flow_convexity_release_summary.json",
        "kpi/proxy.json",
    ):
    ...
    data["deferred_with_reason"] = [
        {
            ...
            "revisit_when": "after C0046 R0002 MT5 evidence files contain measured results",
        }
    ]
...
def update_campaign_status() -> None:
    ...
    next_candidate["direction"] = "active_c0046_r0002_mt5_logic_parity"
    ...
    closeout["remaining_question"] = "produce_c0046_r0002_mt5_logic_parity_evidence"
...
def update_reentry_after_proxy() -> None:
    ...
    data["project"]["active_run"] = "campaigns/C0046_intraday_flow_convexity_release_discovery/runs/R0002"
    ...
    for item in (
        ...
        "open_c0046_r0002_intraday_flow_convexity_release_fragility_survival_run",
        "produce_c0046_r0002_proxy_evidence",
    ):
    ...
    data["active_run"] = "campaigns/C0046_intraday_flow_convexity_release_discovery/runs/R0002"
...
def update_claim_state_after_proxy(payload: dict[str, object]) -> None:
    ...
    data["latest_operation"] = {
        "id": "produce_c0046_r0002_proxy_evidence",
        "status": "completed",
        "recorded_at_source": "campaigns/C0046_intraday_flow_convexity_release_discovery/runs/R0002/kpi/proxy.json",
        ...
        "next_required_action": "produce_c0046_r0002_mt5_logic_parity_evidence",
...
def update_decision_cursor_after_proxy(payload: dict[str, object]) -> None:
    ...
    data["canonical_source"] = "campaigns/C0046_intraday_flow_convexity_release_discovery/runs/R0002/kpi/proxy.json"
    data["canonical_status"] = "proxy_recorded_pending_mt5"
    data["current_decision"] = "produce_c0046_r0002_mt5_logic_parity_evidence"
    data["active_campaign"] = "campaigns/C0046_intraday_flow_convexity_release_discovery"
    data["active_run"] = "campaigns/C0046_intraday_flow_convexity_release_discovery/runs/R0002"
    data["next_required_action"] = "produce_c0046_r0002_mt5_logic_parity_evidence"
    data["current_evidence_summary"] = {
        "source_campaign": "campaigns/C0046_intraday_flow_convexity_release_discovery",
        "current_task": "produce_c0046_r0002_mt5_logic_parity_evidence",
        "active_run": "campaigns/C0046_intraday_flow_convexity_release_discovery/runs/R0002",
        ...
        "proxy_profit_factor": required.get("proxy_profit_factor") if isinstance(required, dict) else None,
        "next_required_action": "produce_c0046_r0002_mt5_logic_parity_evidence",
        "note": "C0046 R0002 proxy evidence recorded; MT5 paired validation remains mandatory regardless of proxy result.",
...
def replace_run_markers(value: Any) -> Any:
    ...
    if isinstance(value, str):
        replacements = {
            "C0004": "C0046",
            "c0004_r0002_fold_local_state_archetype": "c0046_r0002_intraday_flow_convexity_release",
            "c0004_r0002": "c0046_r0002",
