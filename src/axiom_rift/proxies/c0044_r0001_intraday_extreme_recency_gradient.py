"""C0044 R0001 proxy evidence for intraday extreme recency gradient discovery."""
...
RUN_DIR = PROJECT_ROOT / "campaigns" / "C0044_intraday_extreme_recency_gradient_discovery" / "runs" / "R0001"
CAMPAIGN_PATH = PROJECT_ROOT / "campaigns" / "C0044_intraday_extreme_recency_gradient_discovery" / "campaign.yaml"
PROXY_PATH = RUN_DIR / "kpi" / "proxy.json"
TRADE_ARTIFACT_PATH = RUN_DIR / "artifacts" / "c0044_r0001_proxy_trades.csv"
EXTREME_RECENCY_GRADIENT_SUMMARY_PATH = RUN_DIR / "artifacts" / "c0044_r0001_extreme_recency_gradient_summary.json"
...
FEATURE_NAMES = (
    ...
    "rolling_high_recency_12",
    "rolling_low_recency_12",
    "directional_extreme_recency_12",
    "directional_extreme_recency_24",
    "directional_extreme_recency_48",
    "opposite_extreme_recency_24",
    "extreme_refresh_density_12",
    "extreme_refresh_density_24",
    "directional_refresh_density_24",
    "opposite_refresh_density_24",
    "post_extreme_drift_3",
    "post_extreme_drift_6",
    "directional_post_extreme_drift_6",
    "post_extreme_retracement_6",
    "post_extreme_retracement_12",
    "directional_extreme_stall_6",
    "directional_extreme_stall_12",
    "extreme_age_gradient_12_48",
    "day_high_recency",
    "day_low_recency",
    "directional_day_extreme_recency",
    "day_extreme_refresh_density",
    "day_range_position",
    "directional_day_range_position",
    "distance_to_directional_day_extreme",
    "distance_from_opposite_day_extreme",
    "rolling_extreme_band_position_24",
    "directional_band_position_24",
    "extreme_channel_width_24",
    "extreme_channel_width_48",
    "channel_width_change_24_48",
    "close_to_fresh_extreme_pressure",
    "opposite_extreme_pressure_12",
    "failed_extreme_refresh_12",
    "directional_failed_refresh_12",
    "extreme_churn_ratio_12",
    "extreme_path_efficiency_12",
    "normalized_close_return_3",
    "directional_close_streak_12",
    "session_progress",
    "spread_over_range",
    "spread_extreme_stress_24",
    "extreme_regime_contrast_12_48",
)
MODEL_FAMILY = "fold_local_intraday_extreme_recency_gradient_rank"
LABEL_SHAPE = "directional_intraday_extreme_recency_gradient_survival_quality"
POSITIVE_LABEL_THRESHOLD = 0.18
ADVERSE_LABEL_THRESHOLD = -0.36
FEATURE_WEIGHT_FLOOR = 0.25
FEATURE_WEIGHT_CEILING = 2.50
SELECTION_RULE = "top_fold_local_intraday_extreme_recency_gradient_scores_per_active_day"
...
def run_c0044_r0001_proxy(write: bool = True) -> dict[str, object]:
...
def build_proxy_run_result() -> base.ProxyRunResult:
    ...
    price_context = build_extreme_recency_gradient_context(bars, range_average, short_range_average, day_context)
    trades: list[base.Trade] = []
...
def build_candidates(
    ...
    for index in range(start_index, end_index + 1):
        ...
        for direction in (1, -1):
            features = intraday_extreme_recency_gradient_features(
                bars,
                range_average,
                short_range_average,
                day_context,
            ...
            if features is None:
                continue
            label = (
                intraday_extreme_recency_gradient_label(bars, range_average, price_context, index, direction)
                if include_labels
                else None
            )
            ...
            candidates.append(
                base.Candidate(
                    ...
                    state_key=f"{side}|intraday_extreme_recency_gradient",
                    features=features,
                    label=label,
                )
            )
...
def build_extreme_recency_gradient_context(
    bars: list[base.Bar],
    range_average: list[float | None],
    short_range_average: list[float | None],
    day_context: list[dict[str, float] | None],
...
def intraday_extreme_recency_gradient_features(
    bars: list[base.Bar],
    range_average: list[float | None],
    short_range_average: list[float | None],
    day_context: list[dict[str, float] | None],
    ...
    if len(features) != len(FEATURE_NAMES):
        raise RuntimeError(f"C0044 feature length mismatch: {len(features)} != {len(FEATURE_NAMES)}")
    return tuple(float(value) for value in features)


def intraday_extreme_recency_gradient_label(
    bars: list[base.Bar],
    range_average: list[float | None],
    ribbon_context: list[dict[str, float] | None],
    index: int,
    ...
    future_release = future_extreme_recency_gradient_retention(ribbon_context, entry_index, exit_index, direction)
...
def future_extreme_recency_gradient_retention(
    ribbon_context: list[dict[str, float] | None],
    entry_index: int,
    exit_index: int,
    direction: int,
...
def linear_model_summary(model: LinearEdgeModel) -> dict[str, object]:
    return {
        ...
        "score_interpretation": "higher_score_means_direct_fold_local_intraday_extreme_recency_gradient_rank",
    }
...
def build_proxy_payload(
    ...
    payload["campaign_id"] = "C0044"
    payload["work_unit_id"] = "C0044"
    payload["run_id"] = "R0001"
    payload["proxy_id"] = "PX-C0044-R0001"
    payload["proxy_engine"] = "axiom_rift.proxies.c0044_r0001_intraday_extreme_recency_gradient"
    payload["proxy_config_path"] = "campaigns/C0044_intraday_extreme_recency_gradient_discovery/runs/R0001/run_manifest.json"
    payload["split_policy"] = "rolling_window_test_oos_only_with_train_is_intraday_extreme_recency_gradient_rank_fit"
    payload["claim_boundary"] = dict(CLAIM_BOUNDARY)
    payload["proxy_artifact_paths"] = [
        "campaigns/C0044_intraday_extreme_recency_gradient_discovery/runs/R0001/kpi/proxy.json",
        "campaigns/C0044_intraday_extreme_recency_gradient_discovery/runs/R0001/artifacts/c0044_r0001_proxy_trades.csv",
        "campaigns/C0044_intraday_extreme_recency_gradient_discovery/runs/R0001/artifacts/c0044_r0001_extreme_recency_gradient_summary.json",
    ]
    ...
    profiles["intraday_extreme_recency_gradient_profile"] = {  # type: ignore[index]
        "applies": True,
        "fields": {
            "model_family": MODEL_FAMILY,
            "feature_count": len(FEATURE_NAMES),
    ...
    profiles["mt5_pairing_profile"] = {  # type: ignore[index]
        ...
        "fields": {
            ...
            "next_action": "produce_c0044_r0001_mt5_logic_parity_evidence",
        },
    }
    return payload
    ...
    config.update(
        {
            ...
            "score_interpretation": "higher_score_means_direct_fold_local_intraday_extreme_recency_gradient_rank",
            "variant_boundary": (
                "intraday_extreme_recency_gradient_rank_not_effort_absorption_seasonal_residual_tail_risk_skew_entropy_"
...
def write_proxy_evidence(payload: dict[str, object], trades: list[base.Trade]) -> None:
    ...
    write_extreme_recency_gradient_summary_artifact(payload, EXTREME_RECENCY_GRADIENT_SUMMARY_PATH)
    write_text_local(PROXY_PATH, json.dumps(payload, indent=2, sort_keys=True) + "\n")
    trade_hash = sha256_file_local(TRADE_ARTIFACT_PATH)
    summary_hash = sha256_file_local(EXTREME_RECENCY_GRADIENT_SUMMARY_PATH)
...
def write_extreme_recency_gradient_summary_artifact(payload: dict[str, object], path: Path) -> None:
    profiles = payload["conditional_profiles"]  # type: ignore[index]
    summary = {
        "schema": "axiom_rift_fold_local_intraday_extreme_recency_gradient_summary_v1",
        "template": False,
        "work_unit_id": "C0044",
        "campaign_id": "C0044",
        "run_id": "R0001",
        ...
        "intraday_extreme_recency_gradient_profile": profiles["intraday_extreme_recency_gradient_profile"]["fields"],  # type: ignore[index]
...
def update_artifact_lineage(proxy_hash: str, trade_hash: str, summary_hash: str) -> None:
    ...
    records = [
        ...
        if record.get("artifact_role") not in {"proxy_kpi", "proxy_trade_artifact", "intraday_extreme_recency_gradient_summary_artifact"}
    ]
    records.extend(
        [
            artifact_record(
                "A-C0044-R0001-PROXY-KPI",
                "proxy_kpi",
                "json",
                "campaigns/C0044_intraday_extreme_recency_gradient_discovery/runs/R0001/kpi/proxy.json",
                proxy_hash,
                [
                    ...
                    "campaigns/C0044_intraday_extreme_recency_gradient_discovery/runs/R0001/run_manifest.json",
                ],
            ),
            artifact_record(
                "A-C0044-R0001-PROXY-TRADES",
            ...
            artifact_record(
                "A-C0044-R0001-EXTREME-RECENCY-GRADIENT-SUMMARY",
                "intraday_extreme_recency_gradient_summary_artifact",
                "json",
                "campaigns/C0044_intraday_extreme_recency_gradient_discovery/runs/R0001/artifacts/c0044_r0001_extreme_recency_gradient_summary.json",
                summary_hash,
                ["campaigns/C0044_intraday_extreme_recency_gradient_discovery/runs/R0001/kpi/proxy.json"],
...
def artifact_record(
    ...
    return {
        ...
        "sha256": digest,
        "produced_by": "axiom_rift.proxies.c0044_r0001_intraday_extreme_recency_gradient",
...
def update_run_manifest_status() -> None:
    ...
    evidence["proxy_trade_artifact"] = "artifacts/c0044_r0001_proxy_trades.csv"
    evidence["intraday_extreme_recency_gradient_summary"] = "artifacts/c0044_r0001_extreme_recency_gradient_summary.json"
...
def update_gate_report() -> None:
    ...
    data["next_action"] = "produce_c0044_r0001_mt5_logic_parity_evidence"
    evidence_paths = list(data.get("evidence_paths") or [])
    for path in (
        "artifacts/c0044_r0001_proxy_trades.csv",
        "artifacts/c0044_r0001_extreme_recency_gradient_summary.json",
        "kpi/proxy.json",
    ):
    ...
    data["deferred_with_reason"] = [
        {
            ...
            "revisit_when": "after C0044 R0001 MT5 evidence files contain measured results",
        }
    ]
...
def update_campaign_status() -> None:
    ...
    next_candidate["direction"] = "active_c0044_r0001_mt5_logic_parity"
    ...
    closeout["remaining_question"] = "produce_c0044_r0001_mt5_logic_parity_evidence"
...
def update_reentry_after_proxy() -> None:
    ...
    data["project"]["active_campaign"] = "campaigns/C0044_intraday_extreme_recency_gradient_discovery"
    data["project"]["active_run"] = "campaigns/C0044_intraday_extreme_recency_gradient_discovery/runs/R0001"
    next_work = data.setdefault("next_work", {})
    next_work["campaign"] = "campaigns/C0044_intraday_extreme_recency_gradient_discovery"
    completed = list(next_work.get("completed") or [])
    for item in (
        "open_c0044_intraday_extreme_recency_gradient_discovery",
        "open_c0044_r0001_fold_local_intraday_extreme_recency_gradient_rank_run",
        "produce_c0044_r0001_proxy_evidence",
    ):
    ...
    data["active_campaign"] = "campaigns/C0044_intraday_extreme_recency_gradient_discovery"
    data["active_run"] = "campaigns/C0044_intraday_extreme_recency_gradient_discovery/runs/R0001"
...
def update_claim_state_after_proxy(payload: dict[str, object]) -> None:
    ...
    data["latest_operation"] = {
        "id": "produce_c0044_r0001_proxy_evidence",
        "status": "completed",
        "recorded_at_source": "campaigns/C0044_intraday_extreme_recency_gradient_discovery/runs/R0001/kpi/proxy.json",
        ...
        "next_required_action": "produce_c0044_r0001_mt5_logic_parity_evidence",
...
def update_decision_cursor_after_proxy(payload: dict[str, object]) -> None:
    ...
    data["canonical_source"] = "campaigns/C0044_intraday_extreme_recency_gradient_discovery/runs/R0001/kpi/proxy.json"
    data["canonical_status"] = "proxy_recorded_pending_mt5"
    data["current_decision"] = "produce_c0044_r0001_mt5_logic_parity_evidence"
    data["active_campaign"] = "campaigns/C0044_intraday_extreme_recency_gradient_discovery"
    data["active_run"] = "campaigns/C0044_intraday_extreme_recency_gradient_discovery/runs/R0001"
    data["next_required_action"] = "produce_c0044_r0001_mt5_logic_parity_evidence"
    data["current_evidence_summary"] = {
        "source_campaign": "campaigns/C0044_intraday_extreme_recency_gradient_discovery",
        "current_task": "produce_c0044_r0001_mt5_logic_parity_evidence",
        "active_run": "campaigns/C0044_intraday_extreme_recency_gradient_discovery/runs/R0001",
        "active_run_status": "proxy_recorded_pending_mt5",
        "evidence_status": "proxy_recorded_pending_mt5",
        "campaign_family": "intraday_extreme_recency_gradient",
        "entries_per_active_day": summary.get("entries_per_active_day") if isinstance(summary, dict) else None,
        "proxy_trade_count": required.get("proxy_trade_count") if isinstance(required, dict) else None,
        "proxy_net_pnl_points": required.get("proxy_net_pnl_points") if isinstance(required, dict) else None,
        "proxy_profit_factor": required.get("proxy_profit_factor") if isinstance(required, dict) else None,
        "next_required_action": "produce_c0044_r0001_mt5_logic_parity_evidence",
        "note": "C0044 R0001 proxy evidence recorded; MT5 paired validation remains mandatory regardless of proxy result.",
        "source_campaign_manifest": "campaigns/C0044_intraday_extreme_recency_gradient_discovery/campaign.yaml",
    }
...
def replace_run_markers(value: Any) -> Any:
    ...
    if isinstance(value, str):
        replacements = {
            "C0004": "C0044",
            "c0004_r0001_fold_local_state_archetype": "c0044_r0001_intraday_extreme_recency_gradient",
            "c0004_r0001": "c0044_r0001",
            "fold_local_state_archetype_discovery": "intraday_extreme_recency_gradient_discovery",
            ...
            "state_archetype_summary": "intraday_extreme_recency_gradient_summary",
        }
