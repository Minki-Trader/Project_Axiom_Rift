"""C0002 R0004 proxy evidence for a train-only stump-rank ensemble score."""
...
def run_c0002_r0004_proxy(write: bool = True) -> dict[str, object]:
...
def build_proxy_payload(
    ...
    return {
        ...
        "fold_ids": fold_ids,
        "proxy_engine": "axiom_rift.proxies.c0002_r0004_stump_rank_ensemble",
        "proxy_config_path": "campaigns/C0002_score_conditioned_intraday_edge/runs/R0004/run_manifest.json",
        ...
        "conditional_profiles": {
            "score_surface_profile": {
                "applies": True,
                "fields": {
                    "score_type": "train_only_supervised_decision_stump_rank_ensemble",
                    "training_scope": "rolling_train_is_only",
                    "feature_count": len(FEATURE_NAMES),
                    "feature_names": list(FEATURE_NAMES),
                    "feature_family_summary": "directional_closed_bar_price_session_volatility_path_context",
                    ...
                    "model_family": "transparent_decision_stump_rank_ensemble",
                    "fold_models": fold_models,
                    "score_distributions": score_distributions,
                    "candidates_by_fold": candidates_by_fold,
        ...
        "deferred_with_reason": [
            {
                ...
                "revisit_when": "during C0002 R0004 MT5 evidence production",
            ...
            },
            {
                ...
                "revisit_when": "before C0002 R0004 closeout",
                "claim_boundary": {"claim_authority": False},
            },
        ],
        "claim_boundary": {
...
def proxy_config() -> dict[str, object]:
    return {
        ...
        "score_model": "train_only_supervised_decision_stump_rank_ensemble",
...
def update_artifact_lineage(proxy_hash: str) -> None:
    ...
    for record in data.get("artifact_records", []):
        if record.get("artifact_id") == "A0002":
            ...
            record["produced_by"] = "axiom_rift.proxies.c0002_r0004_stump_rank_ensemble"
    ...
    data["deferred_with_reason"] = [
        {
            ...
            "next_action": "produce_c0002_r0004_mt5_logic_parity_evidence",
        }
    ]
...
def update_gate_report() -> None:
    ...
    data["next_action"] = "produce_c0002_r0004_mt5_logic_parity_evidence"
    data["deferred_with_reason"] = [
        {
            "field": "decision",
            ...
            "revisit_when": "after C0002 R0004 MT5 evidence files contain measured results",
        }
    ]
...
def update_campaign_status() -> None:
    ...
    text = text.replace("remaining_question: produce_c0002_r0004_proxy_evidence", "remaining_question: produce_c0002_r0004_mt5_logic_parity_evidence")
    text = text.replace("remaining_question: decide_r0004_or_close_c0002_after_r0003", "remaining_question: produce_c0002_r0004_mt5_logic_parity_evidence")
...
def update_reentry_after_proxy() -> None:
    ...
    if "produce_c0002_r0004_proxy_evidence" not in completed:
        completed.append("produce_c0002_r0004_proxy_evidence")
    next_action = "produce_c0002_r0004_mt5_logic_parity_evidence"
