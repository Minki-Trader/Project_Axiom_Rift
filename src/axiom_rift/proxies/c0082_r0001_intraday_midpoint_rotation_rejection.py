"""C0082 R0001 proxy evidence for intraday midpoint rotation rejection."""
...
TRADE_ARTIFACT_PATH = RUN_DIR / "artifacts" / "c0082_r0001_proxy_trades.csv"
SUMMARY_PATH = RUN_DIR / "artifacts" / "c0082_r0001_mrr_summary.json"
...
MODEL_FAMILY = "fold_local_intraday_midpoint_rotation_rejection_rank"
LABEL_SHAPE = "target_first_escape_quality_conditioned_on_midpoint_rotation_rejection_state"
SELECTION_RULE = "top_fold_local_midpoint_rotation_rejection_scores_per_active_day"
...
def run_c0082_r0001_proxy(write: bool = True) -> dict[str, object]:
...
def build_proxy_run_result() -> base.ProxyRunResult:
    ...
    for fold_id in sorted(fold_id for fold_id, split in windows.items() if {"train_is", "test_oos"} <= set(split)):
        ...
        fold_models.append(linear_midpoint_rotation_rejection_model_summary(model))
...
def build_proxy_payload(
    ...
    return {
        ...
        "split_policy": "rolling_window_test_oos_only_with_train_is_midpoint_rotation_rejection_fit",
        "fold_ids": fold_ids,
        "proxy_engine": "axiom_rift.proxies.c0082_r0001_intraday_midpoint_rotation_rejection",
        ...
        "proxy_artifact_paths": [
            ...
            f"{RUN_REL}/artifacts/c0082_r0001_proxy_trades.csv",
            f"{RUN_REL}/artifacts/c0082_r0001_mrr_summary.json",
        ],
        ...
        "deferred_with_reason": [
            {
                ...
                "blocking_condition": "produce C0082 R0001 MT5 paired validation evidence",
                "revisit_when": "produce_c0082_r0001_mt5_logic_parity_evidence",
            ...
            },
            {
                ...
                "revisit_when": "before C0082 R0001 closeout",
                "claim_boundary": {"claim_authority": False},
            },
        ],
...
def write_summary_artifact(payload: dict[str, object], path: Path) -> None:
    ...
    summary = {
        "schema": "axiom_rift_midpoint_rotation_rejection_summary_v1",
        "template": False,
        "work_unit_id": CAMPAIGN_ID,
        "run_id": RUN_ID,
...
def update_run_manifest_status() -> None:
    ...
    data["mt5_probe_plan"]["next_required_action"] = "produce_c0082_r0001_mt5_logic_parity_evidence"
    evidence = data.setdefault("evidence_paths", {})
    evidence["proxy_kpi"] = "kpi/proxy.json"
    evidence["proxy_trade_artifact"] = "artifacts/c0082_r0001_proxy_trades.csv"
    evidence["midpoint_rotation_rejection_summary"] = "artifacts/c0082_r0001_mrr_summary.json"
...
def update_gate_report() -> None:
    ...
    data["next_action"] = "produce_c0082_r0001_mt5_logic_parity_evidence"
...
def update_campaign_status() -> None:
    ...
    closeout["remaining_question"] = "produce_c0082_r0001_mt5_logic_parity_evidence"
...
def update_selected_status() -> None:
    ...
    data["selected_reason"] = "C0082 R0001 proxy evidence is recorded as a reference surface only; MT5 paired validation and fold-isolated closeout remain mandatory before judgment."
    data["next_required_action"] = "produce_c0082_r0001_mt5_logic_parity_evidence"
...
def update_reentry_after_proxy(payload: dict[str, object]) -> None:
    ...
    for item in (
        "produce_c0082_r0001_proxy_evidence",
    ):
        if item not in completed:
            completed.append(item)
    next_work["tasks"] = ["produce_c0082_r0001_mt5_logic_parity_evidence"]
...
def update_claim_state_after_proxy(payload: dict[str, object]) -> None:
    ...
    data["latest_operation"] = {
        "id": "produce_c0082_r0001_proxy_evidence",
        "status": "completed",
        ...
        "next_required_action": "produce_c0082_r0001_mt5_logic_parity_evidence",
        "claim_boundary": CLAIM_BOUNDARY,
    }
...
def update_decision_cursor_after_proxy(payload: dict[str, object]) -> None:
    ...
    data["current_decision"] = "produce_c0082_r0001_mt5_logic_parity_evidence"
    data["active_campaign"] = WORK_UNIT_REL
    data["active_run"] = RUN_REL
    data["active_synthesis"] = None
    data["next_required_action"] = "produce_c0082_r0001_mt5_logic_parity_evidence"
    ...
    summary.update(
        {
            ...
            "evidence_status": "proxy_recorded_pending_mt5",
            "current_task": "produce_c0082_r0001_mt5_logic_parity_evidence",
            "next_required_action": "produce_c0082_r0001_mt5_logic_parity_evidence",
            ...
            "note": "C0082 R0001 proxy evidence is recorded; MT5 paired validation remains mandatory and no selection or economics claim is created.",
        }
    )
    data["next_decision_basis"] = [
        {
            ...
            "summary": "C0082 R0001 proxy evidence recorded as reference surface only; MT5 logic parity is next.",
        },
        {
...
def append_decision_registry_after_proxy(payload: dict[str, object]) -> None:
    ...
    summary = payload["proxy_summary"]  # type: ignore[index]
    block = f"""
- decision_id: dec_20260707_produce_c0082_r0001_proxy_evidence
  created_local_date: '2026-07-06'
  status: active
  decision: produce_c0082_r0001_proxy_evidence
  refines:
  - dec_20260707_open_c0082_r0001_intraday_midpoint_rotation_rejection_rank_run
  - dec_20260701_mandatory_mt5_paired_run_validation
  rationale:
  - c0082_r0001_proxy_records_midpoint_rotation_rejection_reference_surface
  ...
  - next_work_is_produce_c0082_r0001_mt5_logic_parity_evidence
  ...
  claim_boundary:
    ...
    live_ready: false
"""
    if "dec_20260707_produce_c0082_r0001_proxy_evidence" not in text:
...
def update_artifact_lineage(proxy_hash: str, trade_hash: str, summary_hash: str) -> None:
    ...
    data["artifact_records"] = [
        {
            "artifact_id": "A-C0082-R0001-RUN-MANIFEST",
            "artifact_role": "run_manifest",
            "artifact_type": "json",
            "repo_relative_path": f"{RUN_REL}/run_manifest.json",
            "sha256": run_manifest_hash,
            "produced_by": "axiom_rift.proxies.c0082_r0001_intraday_midpoint_rotation_rejection",
            "source_inputs": [
        ...
        {
            "artifact_id": "A-C0082-R0001-GATE-REPORT",
        ...
        {
            "artifact_id": "A-C0082-R0001-PROXY-KPI",
        ...
        {
            "artifact_id": "A-C0082-R0001-PROXY-TRADES",
            "artifact_role": "proxy_trade_artifact",
            "artifact_type": "csv",
            "repo_relative_path": f"{RUN_REL}/artifacts/c0082_r0001_proxy_trades.csv",
            "sha256": trade_hash,
            "produced_by": "axiom_rift.proxies.c0082_r0001_intraday_midpoint_rotation_rejection",
            "source_inputs": [
                "data/processed/datasets/us100_m5_base_frame.csv",
        ...
        {
            "artifact_id": "A-C0082-R0001-midpoint-rotation-rejection-SUMMARY",
            "artifact_role": "midpoint_rotation_rejection_summary_artifact",
            "artifact_type": "json",
            "repo_relative_path": f"{RUN_REL}/artifacts/c0082_r0001_mrr_summary.json",
            "sha256": summary_hash,
            "produced_by": "axiom_rift.proxies.c0082_r0001_intraday_midpoint_rotation_rejection",
            "source_inputs": [
                f"{RUN_REL}/kpi/proxy.json",
    ...
    data["deferred_with_reason"] = [
        {
            ...
            "next_action": "produce_c0082_r0001_mt5_logic_parity_evidence",
        }
    ]
