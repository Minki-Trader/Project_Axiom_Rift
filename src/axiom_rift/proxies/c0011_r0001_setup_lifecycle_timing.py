"""C0011 R0001 proxy evidence for setup lifecycle timing discovery."""
...
RUN_DIR = PROJECT_ROOT / "campaigns" / "C0011_setup_lifecycle_timing_discovery" / "runs" / "R0001"
...
TRADE_ARTIFACT_PATH = RUN_DIR / "artifacts" / "c0011_r0001_proxy_trades.csv"
LIFECYCLE_SUMMARY_PATH = RUN_DIR / "artifacts" / "c0011_r0001_setup_lifecycle_summary.json"
...
MODEL_FAMILY = "fold_local_setup_lifecycle_phase_timing_rank"
LABEL_SHAPE = "early_favorable_impulse_target_first_minus_adverse_decay"
SELECTION_RULE = "top_fold_local_setup_lifecycle_trigger_or_confirmation_scores_per_active_day"
...
PHASES_ALLOWED_FOR_ENTRY = {"trigger", "early_confirmation"}
...
def run_c0011_r0001_proxy(write: bool = True) -> dict[str, object]:
...
def build_candidates(
    ...
    for index in range(start_index, end_index + 1):
        ...
        for direction in (1, -1):
            snapshot = setup_lifecycle_snapshot(bars, range_series, index, direction)
            if snapshot is None or snapshot.phase not in PHASES_ALLOWED_FOR_ENTRY:
                continue
            label = setup_lifecycle_label(bars, range_series, index, direction, snapshot) if include_labels else None
            candidates.append(
                base.Candidate(
                    fold_id=fold_id,
                    index=index,
...
def build_proxy_payload(
    ...
    payload["proxy_id"] = "PX-C0011-R0001"
    payload["proxy_engine"] = "axiom_rift.proxies.c0011_r0001_setup_lifecycle_timing"
    payload["proxy_config_path"] = "campaigns/C0011_setup_lifecycle_timing_discovery/runs/R0001/run_manifest.json"
    payload["split_policy"] = "rolling_window_test_oos_only_with_train_is_setup_lifecycle_rank_fit"
    payload["proxy_artifact_paths"] = [
        "campaigns/C0011_setup_lifecycle_timing_discovery/runs/R0001/kpi/proxy.json",
        "campaigns/C0011_setup_lifecycle_timing_discovery/runs/R0001/artifacts/c0011_r0001_proxy_trades.csv",
        "campaigns/C0011_setup_lifecycle_timing_discovery/runs/R0001/artifacts/c0011_r0001_setup_lifecycle_summary.json",
    ]
    ...
    profiles["setup_lifecycle_timing_profile"] = {  # type: ignore[index]
        "applies": True,
        "fields": {
            ...
            "phases_allowed_for_entry": sorted(PHASES_ALLOWED_FOR_ENTRY),
            "fold_models": fold_models,
            "state_distributions": state_distributions,
            "candidates_by_fold": candidates_by_fold,
    ...
    profiles["mt5_pairing_profile"] = {  # type: ignore[index]
        ...
        "fields": {
            ...
            "next_action": "produce_c0011_r0001_mt5_logic_parity_evidence",
        },
    }
    return payload
    ...
    config.update(
        {
            ...
            "trigger_freshness_bars": TRIGGER_FRESHNESS_BARS,
            "phases_allowed_for_entry": sorted(PHASES_ALLOWED_FOR_ENTRY),
            "score_interpretation": "higher_score_means_fold_local_setup_lifecycle_timing_quality",
            "variant_boundary": "setup_birth_maturity_trigger_confirmation_decay_timing_not_monthly_score_cost_stop_target_session_or_retry_nudge",
        }
    )
    return config
...
def write_lifecycle_summary_artifact(payload: dict[str, object], path: Path) -> None:
    profiles = payload["conditional_profiles"]  # type: ignore[index]
    summary = {
        "schema": "axiom_rift_fold_local_setup_lifecycle_timing_summary_v1",
        "template": False,
        "work_unit_id": "C0011",
        "campaign_id": "C0011",
        "run_id": "R0001",
        ...
        "setup_lifecycle_timing_profile": profiles["setup_lifecycle_timing_profile"]["fields"],  # type: ignore[index]
...
def update_artifact_lineage(proxy_hash: str, trade_hash: str, summary_hash: str) -> None:
    ...
    records = [
        ...
        if record.get("artifact_role") not in {"proxy_kpi", "proxy_trade_artifact", "setup_lifecycle_summary_artifact"}
    ]
    records.extend(
        [
            artifact_record(
                "A-C0011-R0001-PROXY-KPI",
                "proxy_kpi",
                "json",
                "campaigns/C0011_setup_lifecycle_timing_discovery/runs/R0001/kpi/proxy.json",
                proxy_hash,
                [
                    ...
                    "campaigns/C0011_setup_lifecycle_timing_discovery/runs/R0001/run_manifest.json",
                ],
            ),
            artifact_record(
                "A-C0011-R0001-PROXY-TRADES",
            ...
            artifact_record(
                "A-C0011-R0001-SETUP-LIFECYCLE-SUMMARY",
                "setup_lifecycle_summary_artifact",
                "json",
                "campaigns/C0011_setup_lifecycle_timing_discovery/runs/R0001/artifacts/c0011_r0001_setup_lifecycle_summary.json",
                summary_hash,
                ["campaigns/C0011_setup_lifecycle_timing_discovery/runs/R0001/kpi/proxy.json"],
...
def artifact_record(
    ...
    return {
        ...
        "sha256": digest,
        "produced_by": "axiom_rift.proxies.c0011_r0001_setup_lifecycle_timing",
...
def update_run_manifest_status() -> None:
    ...
    evidence["proxy_trade_artifact"] = "artifacts/c0011_r0001_proxy_trades.csv"
    evidence["setup_lifecycle_summary"] = "artifacts/c0011_r0001_setup_lifecycle_summary.json"
...
def update_gate_report() -> None:
    ...
    data["next_action"] = "produce_c0011_r0001_mt5_logic_parity_evidence"
    evidence_paths = list(data.get("evidence_paths") or [])
    for path in (
        "artifacts/c0011_r0001_proxy_trades.csv",
        "artifacts/c0011_r0001_setup_lifecycle_summary.json",
        "kpi/proxy.json",
    ):
    ...
    data["deferred_with_reason"] = [
        {
            ...
            "revisit_when": "after C0011 R0001 MT5 evidence files contain measured results",
        }
    ]
...
def update_campaign_status() -> None:
    ...
    next_candidate["direction"] = "active_c0011_r0001_mt5_logic_parity"
    ...
    closeout["remaining_question"] = "produce_c0011_r0001_mt5_logic_parity_evidence"
...
def update_reentry_after_proxy() -> None:
    ...
    for item in (
        ...
        "open_c0011_r0001_setup_lifecycle_timing_run",
        "produce_c0011_r0001_proxy_evidence",
    ):
...
def update_claim_state_after_proxy(payload: dict[str, object]) -> None:
    ...
    data["latest_operation"] = {
        "id": "produce_c0011_r0001_proxy_evidence",
        "status": "completed",
        "recorded_at_source": "campaigns/C0011_setup_lifecycle_timing_discovery/runs/R0001/kpi/proxy.json",
        ...
        "next_required_action": "produce_c0011_r0001_mt5_logic_parity_evidence",
        "claim_boundary": {
            "claim_authority": False,
            "selected": False,
            "label_selected": False,
...
def replace_run_markers(value: Any) -> Any:
    ...
    if isinstance(value, str):
        replacements = {
            "C0004": "C0011",
            "c0004_r0001_fold_local_state_archetype": "c0011_r0001_setup_lifecycle_timing",
            "c0004_r0001": "c0011_r0001",
            ...
            "state_archetype_summary": "setup_lifecycle_summary",
        }
