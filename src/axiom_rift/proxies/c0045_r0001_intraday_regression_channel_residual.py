"""C0045 R0001 proxy evidence for intraday regression channel residual discovery."""
...
RUN_DIR = PROJECT_ROOT / "campaigns" / "C0045_intraday_regression_channel_residual_discovery" / "runs" / "R0001"
...
TRADE_ARTIFACT_PATH = RUN_DIR / "artifacts" / "c0045_r0001_proxy_trades.csv"
REGRESSION_CHANNEL_RESIDUAL_SUMMARY_PATH = RUN_DIR / "artifacts" / "c0045_r0001_regression_channel_residual_summary.json"
...
MODEL_FAMILY = "fold_local_intraday_regression_channel_residual_rank"
LABEL_SHAPE = "directional_intraday_regression_channel_residual_survival_quality"
POSITIVE_LABEL_THRESHOLD = 0.18
ADVERSE_LABEL_THRESHOLD = -0.36
FEATURE_WEIGHT_FLOOR = 0.25
FEATURE_WEIGHT_CEILING = 2.50
SELECTION_RULE = "top_fold_local_intraday_regression_channel_residual_scores_per_active_day"
...
def run_c0045_r0001_proxy(write: bool = True) -> dict[str, object]:
        ...
        for direction in (1, -1):
            ...
            candidates.append(
                base.Candidate(
                    ...
                    state_key=f"{side}|intraday_regression_channel_residual",
                    features=features,
                    label=label,
                )
            )
...
def linear_model_summary(model: LinearEdgeModel) -> dict[str, object]:
    return {
        ...
        "score_interpretation": "higher_score_means_direct_fold_local_intraday_regression_channel_residual_rank",
    }
...
def build_proxy_payload(
    ...
    payload["proxy_id"] = "PX-C0045-R0001"
    payload["proxy_engine"] = "axiom_rift.proxies.c0045_r0001_intraday_regression_channel_residual"
    payload["proxy_config_path"] = "campaigns/C0045_intraday_regression_channel_residual_discovery/runs/R0001/run_manifest.json"
    ...
    payload["proxy_artifact_paths"] = [
        "campaigns/C0045_intraday_regression_channel_residual_discovery/runs/R0001/kpi/proxy.json",
        "campaigns/C0045_intraday_regression_channel_residual_discovery/runs/R0001/artifacts/c0045_r0001_proxy_trades.csv",
        "campaigns/C0045_intraday_regression_channel_residual_discovery/runs/R0001/artifacts/c0045_r0001_regression_channel_residual_summary.json",
    ]
    ...
    profiles["mt5_pairing_profile"] = {  # type: ignore[index]
        ...
        "fields": {
            ...
            "next_action": "produce_c0045_r0001_mt5_logic_parity_evidence",
        },
    }
    return payload
    ...
    config.update(
        {
            ...
            "score_interpretation": "higher_score_means_direct_fold_local_intraday_regression_channel_residual_rank",
            "variant_boundary": (
                "intraday_regression_channel_residual_rank_not_effort_absorption_seasonal_residual_tail_risk_skew_entropy_"
        ...
        [
            artifact_record(
                ...
                [
                    ...
                    "campaigns/C0045_intraday_regression_channel_residual_discovery/runs/R0001/run_manifest.json",
                ],
            ),
            artifact_record(
                "A-C0045-R0001-PROXY-TRADES",
            ...
            artifact_record(
                "A-C0045-R0001-REGRESSION-CHANNEL-RESIDUAL-SUMMARY",
...
def artifact_record(
    ...
    return {
        ...
        "sha256": digest,
        "produced_by": "axiom_rift.proxies.c0045_r0001_intraday_regression_channel_residual",
...
def update_run_manifest_status() -> None:
    ...
    evidence["proxy_trade_artifact"] = "artifacts/c0045_r0001_proxy_trades.csv"
    evidence["intraday_regression_channel_residual_summary"] = "artifacts/c0045_r0001_regression_channel_residual_summary.json"
...
def update_gate_report() -> None:
    ...
    data["next_action"] = "produce_c0045_r0001_mt5_logic_parity_evidence"
    evidence_paths = list(data.get("evidence_paths") or [])
    for path in (
        "artifacts/c0045_r0001_proxy_trades.csv",
        "artifacts/c0045_r0001_regression_channel_residual_summary.json",
        "kpi/proxy.json",
    ):
    ...
    data["deferred_with_reason"] = [
        {
            ...
            "revisit_when": "after C0045 R0001 MT5 evidence files contain measured results",
        }
    ]
...
def update_campaign_status() -> None:
    ...
    next_candidate["direction"] = "active_c0045_r0001_mt5_logic_parity"
    ...
    closeout["remaining_question"] = "produce_c0045_r0001_mt5_logic_parity_evidence"
...
def update_reentry_after_proxy() -> None:
    ...
    data["project"]["active_run"] = "campaigns/C0045_intraday_regression_channel_residual_discovery/runs/R0001"
    ...
    for item in (
        ...
        "open_c0045_r0001_fold_local_intraday_regression_channel_residual_rank_run",
        "produce_c0045_r0001_proxy_evidence",
    ):
    ...
    data["active_run"] = "campaigns/C0045_intraday_regression_channel_residual_discovery/runs/R0001"
...
def update_claim_state_after_proxy(payload: dict[str, object]) -> None:
    ...
    data["latest_operation"] = {
        "id": "produce_c0045_r0001_proxy_evidence",
        "status": "completed",
        "recorded_at_source": "campaigns/C0045_intraday_regression_channel_residual_discovery/runs/R0001/kpi/proxy.json",
        ...
        "next_required_action": "produce_c0045_r0001_mt5_logic_parity_evidence",
...
def update_decision_cursor_after_proxy(payload: dict[str, object]) -> None:
    ...
    data["canonical_source"] = "campaigns/C0045_intraday_regression_channel_residual_discovery/runs/R0001/kpi/proxy.json"
    data["canonical_status"] = "proxy_recorded_pending_mt5"
    data["current_decision"] = "produce_c0045_r0001_mt5_logic_parity_evidence"
    data["active_campaign"] = "campaigns/C0045_intraday_regression_channel_residual_discovery"
    data["active_run"] = "campaigns/C0045_intraday_regression_channel_residual_discovery/runs/R0001"
    data["next_required_action"] = "produce_c0045_r0001_mt5_logic_parity_evidence"
    data["current_evidence_summary"] = {
        "source_campaign": "campaigns/C0045_intraday_regression_channel_residual_discovery",
        "current_task": "produce_c0045_r0001_mt5_logic_parity_evidence",
        "active_run": "campaigns/C0045_intraday_regression_channel_residual_discovery/runs/R0001",
        ...
        "proxy_profit_factor": required.get("proxy_profit_factor") if isinstance(required, dict) else None,
        "next_required_action": "produce_c0045_r0001_mt5_logic_parity_evidence",
        "note": "C0045 R0001 proxy evidence recorded; MT5 paired validation remains mandatory regardless of proxy result.",
...
def replace_run_markers(value: Any) -> Any:
    ...
    if isinstance(value, str):
        replacements = {
            "C0004": "C0045",
            "c0004_r0001_fold_local_state_archetype": "c0045_r0001_intraday_regression_channel_residual",
            "c0004_r0001": "c0045_r0001",
...
def intraday_regression_channel_residual_label(
    ...
    return (
        ...
        - 0.22 * future_path_churn(path, entry)
        - 1.05 * spread_norm
        - 0.18 * max(0.0, path_spread_peak - spread_norm)
        - 0.16 * context["spread_channel_stress_24"]
    )
