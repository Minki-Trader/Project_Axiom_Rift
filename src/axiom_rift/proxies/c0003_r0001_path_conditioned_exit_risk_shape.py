"""C0003 R0001 proxy evidence for path-conditioned exit and risk shape."""
...
RUN_DIR = PROJECT_ROOT / "campaigns" / "C0003_path_conditioned_exit_risk_shape" / "runs" / "R0001"
...
TRADE_ARTIFACT_PATH = RUN_DIR / "artifacts" / "c0003_r0001_proxy_trades.csv"
...
RISK_PROFILES = {
    "defensive": {
        "stop_range_multiple": 0.55,
        "target_range_multiple": 0.85,
        "max_hold_bars": 8,
        "early_exit_bars": 4,
    ...
    "runner": {
        "stop_range_multiple": 0.85,
        "target_range_multiple": 1.65,
        "max_hold_bars": 18,
        "early_exit_bars": None,
        "trail_activation_range_multiple": 1.00,
        "trail_distance_range_multiple": 0.65,
    },
}
...
def run_c0003_r0001_proxy(write: bool = True) -> dict[str, object]:
...
def candidate_label(
    ...
    best_ratio = best_profile_survival_ratio(mfe_ratio, mae_ratio, terminal_ratio)
    return (0.55 * best_ratio) + (0.25 * mfe_ratio) - (0.35 * mae_ratio) + (0.20 * terminal_ratio)
...
def build_trade(
    ...
    direction = candidate.direction
    risk_profile = candidate.risk_profile or "balanced"
...
def build_proxy_payload(
    ...
    return {
        ...
        "fold_ids": fold_ids,
        "proxy_engine": "axiom_rift.proxies.c0003_r0001_path_conditioned_exit_risk_shape",
        "proxy_config_path": "campaigns/C0003_path_conditioned_exit_risk_shape/runs/R0001/run_manifest.json",
        "proxy_code_version_or_commit": "uncommitted_local_worktree_at_proxy_creation",
        "proxy_artifact_paths": [
            "campaigns/C0003_path_conditioned_exit_risk_shape/runs/R0001/kpi/proxy.json",
            "campaigns/C0003_path_conditioned_exit_risk_shape/runs/R0001/artifacts/c0003_r0001_proxy_trades.csv",
        ],
        ...
        "conditional_profiles": {
            "score_surface_profile": {
                "applies": True,
                "fields": {
                    "score_type": "train_only_path_survival_stump_score",
                    "training_scope": "rolling_train_is_only",
                    "feature_count": len(FEATURE_NAMES),
                    "feature_names": list(FEATURE_NAMES),
                    "feature_family_summary": "directional_closed_bar_price_session_volatility_pullback_context",
                    "label_horizon": LABEL_HORIZON_BARS,
                    "label_shape": "best_path_risk_profile_plus_excursion_survivability",
                    "entry_count_per_active_day_target": "5_to_10",
                    "entries_per_active_day": rounded(entries_per_active_day),
                    "max_entries_per_active_day": MAX_ENTRIES_PER_ACTIVE_DAY,
                    "selection_rule": "top_ranked_candidates_per_active_day_without_positive_score_gate",
                    "model_family": "transparent_decision_stump_path_survival_surface",
                    "fold_models": fold_models,
                    "score_distributions": score_distributions,
                    "candidates_by_fold": candidates_by_fold,
        ...
        "deferred_with_reason": [
            {
                ...
                "revisit_when": "during C0003 R0001 MT5 evidence production",
            ...
            },
            {
                ...
                "revisit_when": "before C0003 R0001 closeout",
                "claim_boundary": {"claim_authority": False},
            },
        ],
        "claim_boundary": {
...
def proxy_config() -> dict[str, object]:
    return {
        ...
        "score_model": "train_only_path_survival_decision_stump_surface",
        ...
        [
            {
                ...
                "artifact_type": "json",
                "repo_relative_path": "campaigns/C0003_path_conditioned_exit_risk_shape/runs/R0001/kpi/proxy.json",
                "sha256": proxy_hash,
                "produced_by": "axiom_rift.proxies.c0003_r0001_path_conditioned_exit_risk_shape",
                "source_inputs": [
                    "data/processed/datasets/us100_m5_base_frame.csv",
                    "data/processed/coverage_audits/us100_m5_rolling_windows.csv",
                    "campaigns/C0003_path_conditioned_exit_risk_shape/runs/R0001/run_manifest.json",
                ],
            ...
            },
            {
                ...
                "artifact_type": "csv",
                "repo_relative_path": "campaigns/C0003_path_conditioned_exit_risk_shape/runs/R0001/artifacts/c0003_r0001_proxy_trades.csv",
                "sha256": trade_hash,
                "produced_by": "axiom_rift.proxies.c0003_r0001_path_conditioned_exit_risk_shape",
                "source_inputs": [
                    "data/processed/datasets/us100_m5_base_frame.csv",
    ...
    data["deferred_with_reason"] = [
        {
            ...
            "next_action": "produce_c0003_r0001_mt5_logic_parity_evidence",
        }
    ]
...
def update_run_manifest_status() -> None:
    ...
    data.setdefault("evidence_paths", {})["proxy_trade_artifact"] = "artifacts/c0003_r0001_proxy_trades.csv"
...
def update_gate_report() -> None:
    ...
    data["next_action"] = "produce_c0003_r0001_mt5_logic_parity_evidence"
    evidence_paths = list(data.get("evidence_paths") or [])
    for path in (
        "artifacts/c0003_r0001_proxy_trades.csv",
        "kpi/proxy.json",
    ):
    ...
    data["deferred_with_reason"] = [
        {
            ...
            "revisit_when": "after C0003 R0001 MT5 evidence files contain measured results",
        }
    ]
...
def update_campaign_status() -> None:
    ...
    text = text.replace("remaining_question: produce_c0003_r0001_proxy_evidence", "remaining_question: produce_c0003_r0001_mt5_logic_parity_evidence")
...
def update_reentry_after_proxy() -> None:
    ...
    if "produce_c0003_r0001_proxy_evidence" not in completed:
        completed.append("produce_c0003_r0001_proxy_evidence")
    next_action = "produce_c0003_r0001_mt5_logic_parity_evidence"
...
if __name__ == "__main__":
    payload = run_c0003_r0001_proxy(write=True)
