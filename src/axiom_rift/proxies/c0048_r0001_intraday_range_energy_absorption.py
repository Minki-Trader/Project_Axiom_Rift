"""C0048 R0001 proxy evidence for intraday range_energy absorption dislocation discovery."""
...
RUN_DIR = PROJECT_ROOT / "campaigns" / "C0048_intraday_range_energy_absorption_discovery" / "runs" / "R0001"
...
TRADE_ARTIFACT_PATH = RUN_DIR / "artifacts" / "c0048_r0001_proxy_trades.csv"
INTRADAY_RANGE_ENERGY_ABSORPTION_SUMMARY_PATH = RUN_DIR / "artifacts" / "c0048_r0001_range_energy_absorption_summary.json"
...
FEATURE_NAMES = (
    "direction_bias",
    "directional_close_return_1_atr",
    "directional_close_return_3_atr",
    "directional_close_return_6_atr",
    "directional_body_energy_1",
    "directional_body_energy_3",
    "directional_body_energy_6",
    "body_range_fraction_1",
    "body_range_fraction_3",
    "range_expansion_1_vs_48",
    "range_expansion_3_vs_24",
    "range_expansion_6_vs_48",
    "range_compression_6_vs_48",
    "adverse_probe_wick_absorption_1",
    "adverse_probe_wick_absorption_3",
    "favorable_extension_wick_3",
    "close_location_directional_1",
    "close_location_directional_3",
    "adverse_probe_recovery_score",
    "failed_extension_rate_6",
    "containment_break_rate_6",
    "prior_range_return_rate_6",
    "directional_box_position_12",
    "directional_escape_pressure_12",
    "directional_path_efficiency_12",
    "churn_ratio_12",
    "close_sign_imbalance_6",
    "close_sign_churn_6",
    ...
    "spread_over_range",
    "spread_range_stress",
    "range_energy_absorption_interaction",
)
MODEL_FAMILY = "fold_local_intraday_range_energy_absorption_rank"
LABEL_SHAPE = "directional_intraday_range_energy_absorption_survival_quality"
POSITIVE_LABEL_THRESHOLD = 0.18
ADVERSE_LABEL_THRESHOLD = -0.36
FEATURE_WEIGHT_FLOOR = 0.25
FEATURE_WEIGHT_CEILING = 2.50
SELECTION_RULE = "top_fold_local_intraday_range_energy_absorption_scores_per_active_day"
...
def run_c0048_r0001_proxy(write: bool = True) -> dict[str, object]:
        ...
        for direction in (1, -1):
            ...
            candidates.append(
                base.Candidate(
                    ...
                    state_key=f"{side}|intraday_range_energy_absorption",
                    features=features,
                    label=label,
                )
            )
...
def intraday_range_energy_absorption_features(
    ...
    range_expansion_3_vs_24 = range_3 / max(range_24, 1e-9)
    range_expansion_6_vs_48 = range_6 / max(range_48, 1e-9)
    ...
    failed_extension = directional_failed_extension_rate(bars, index, direction, 6)
    containment_break = containment_break_rate(bars, index, 6)
    prior_range_return = directional_return_to_prior_range(bars, index, direction, 6)
    box_position_12 = directional_box_position(bars, index, direction, 12)
    ...
    range_absorption_pressure_6 = adverse_wick_3 * (1.0 + range_compression_6_vs_48) + max(0.0, counter_pressure_6 - directional_return_3)
    ...
    absorption_interaction = (
        adverse_recovery
        + max(0.0, body_energy_3)
        + max(0.0, directional_return_3)
        + 0.20 * prior_range_return
        - spread_range_stress
        - 0.25 * max(0.0, counter_pressure_6)
    )
    return (
        float(direction),
...
def intraday_range_energy_absorption_label(
    ...
    return (
        ...
        + 0.30 * future_range_energy_acceptance
        + 0.24 * future_directional_bias
        + 0.20 * future_absorption_retention
...
def build_proxy_payload(
    ...
    payload["proxy_id"] = "PX-C0048-R0001"
    payload["proxy_engine"] = "axiom_rift.proxies.c0048_r0001_intraday_range_energy_absorption"
    payload["proxy_config_path"] = "campaigns/C0048_intraday_range_energy_absorption_discovery/runs/R0001/run_manifest.json"
    ...
    payload["proxy_artifact_paths"] = [
        "campaigns/C0048_intraday_range_energy_absorption_discovery/runs/R0001/kpi/proxy.json",
        "campaigns/C0048_intraday_range_energy_absorption_discovery/runs/R0001/artifacts/c0048_r0001_proxy_trades.csv",
        "campaigns/C0048_intraday_range_energy_absorption_discovery/runs/R0001/artifacts/c0048_r0001_range_energy_absorption_summary.json",
    ]
    ...
    profiles["intraday_range_energy_absorption_profile"] = {  # type: ignore[index]
        "applies": True,
        "fields": {
    ...
    profiles["mt5_pairing_profile"] = {  # type: ignore[index]
        ...
        "fields": {
            ...
            "next_action": "produce_c0048_r0001_mt5_logic_parity_evidence",
        },
    }
    return payload
    ...
    config.update(
        {
            ...
            "feature_weight_floor": FEATURE_WEIGHT_FLOOR,
            "feature_weight_ceiling": FEATURE_WEIGHT_CEILING,
            "score_interpretation": "higher_score_means_direct_fold_local_intraday_range_energy_absorption_rank",
            "variant_boundary": (
                "intraday_range_energy_absorption_rank_not_vwap_source_synthesis_range_overlap_calendar_phase_tick_participation_"
...
def write_proxy_evidence(payload: dict[str, object], trades: list[base.Trade]) -> None:
    ...
    write_intraday_range_energy_absorption_summary_artifact(payload, INTRADAY_RANGE_ENERGY_ABSORPTION_SUMMARY_PATH)
...
def write_intraday_range_energy_absorption_summary_artifact(payload: dict[str, object], path: Path) -> None:
    profiles = payload["conditional_profiles"]  # type: ignore[index]
    summary = {
        "schema": "axiom_rift_fold_local_intraday_range_energy_absorption_summary_v1",
        "template": False,
        "work_unit_id": "C0048",
        "campaign_id": "C0048",
        "run_id": "R0001",
        ...
        "intraday_range_energy_absorption_profile": profiles["intraday_range_energy_absorption_profile"]["fields"],  # type: ignore[index]
...
def update_artifact_lineage(proxy_hash: str, trade_hash: str, summary_hash: str) -> None:
    ...
    records = [
        ...
        if record.get("artifact_role") not in {"proxy_kpi", "proxy_trade_artifact", "intraday_range_energy_absorption_summary_artifact"}
    ]
    records.extend(
        [
            artifact_record(
                "A-C0048-R0001-PROXY-KPI",
                "proxy_kpi",
                "json",
                "campaigns/C0048_intraday_range_energy_absorption_discovery/runs/R0001/kpi/proxy.json",
                proxy_hash,
                [
                    ...
                    "campaigns/C0048_intraday_range_energy_absorption_discovery/runs/R0001/run_manifest.json",
                ],
            ),
            artifact_record(
                "A-C0048-R0001-PROXY-TRADES",
            ...
            artifact_record(
                "A-C0048-R0001-RANGE-ENERGY-ABSORPTION-SUMMARY",
                "intraday_range_energy_absorption_summary_artifact",
                "json",
                "campaigns/C0048_intraday_range_energy_absorption_discovery/runs/R0001/artifacts/c0048_r0001_range_energy_absorption_summary.json",
                summary_hash,
                ["campaigns/C0048_intraday_range_energy_absorption_discovery/runs/R0001/kpi/proxy.json"],
...
def artifact_record(
    ...
    return {
        ...
        "sha256": digest,
        "produced_by": "axiom_rift.proxies.c0048_r0001_intraday_range_energy_absorption",
...
def update_run_manifest_status() -> None:
    ...
    evidence["proxy_trade_artifact"] = "artifacts/c0048_r0001_proxy_trades.csv"
    evidence["intraday_range_energy_absorption_summary"] = "artifacts/c0048_r0001_range_energy_absorption_summary.json"
...
def update_gate_report() -> None:
    ...
    data["next_action"] = "produce_c0048_r0001_mt5_logic_parity_evidence"
    evidence_paths = list(data.get("evidence_paths") or [])
    for path in (
        "artifacts/c0048_r0001_proxy_trades.csv",
        "artifacts/c0048_r0001_range_energy_absorption_summary.json",
        "kpi/proxy.json",
    ):
    ...
    data["deferred_with_reason"] = [
        {
            ...
            "revisit_when": "after C0048 R0001 MT5 evidence files contain measured results",
        }
    ]
...
def update_campaign_status() -> None:
    ...
    next_candidate["direction"] = "active_c0048_r0001_mt5_logic_parity"
    ...
    closeout["remaining_question"] = "produce_c0048_r0001_mt5_logic_parity_evidence"
...
def update_reentry_after_proxy() -> None:
    ...
    data["project"]["active_run"] = "campaigns/C0048_intraday_range_energy_absorption_discovery/runs/R0001"
    ...
    for item in (
        ...
        "open_c0048_r0001_fold_local_intraday_range_energy_absorption_rank_run",
        "produce_c0048_r0001_proxy_evidence",
    ):
    ...
    data["active_run"] = "campaigns/C0048_intraday_range_energy_absorption_discovery/runs/R0001"
...
def update_claim_state_after_proxy(payload: dict[str, object]) -> None:
    ...
    data["latest_operation"] = {
        "id": "produce_c0048_r0001_proxy_evidence",
        "status": "completed",
        "recorded_at_source": "campaigns/C0048_intraday_range_energy_absorption_discovery/runs/R0001/kpi/proxy.json",
        ...
        "next_required_action": "produce_c0048_r0001_mt5_logic_parity_evidence",
...
def update_decision_cursor_after_proxy(payload: dict[str, object]) -> None:
    ...
    data["canonical_source"] = "campaigns/C0048_intraday_range_energy_absorption_discovery/runs/R0001/kpi/proxy.json"
    data["canonical_status"] = "proxy_recorded_pending_mt5"
    data["current_decision"] = "produce_c0048_r0001_mt5_logic_parity_evidence"
    data["active_campaign"] = "campaigns/C0048_intraday_range_energy_absorption_discovery"
    data["active_run"] = "campaigns/C0048_intraday_range_energy_absorption_discovery/runs/R0001"
    data["active_synthesis"] = None
    data["next_required_action"] = "produce_c0048_r0001_mt5_logic_parity_evidence"
    data["current_evidence_summary"] = {
        "source_campaign": "campaigns/C0048_intraday_range_energy_absorption_discovery",
        "current_task": "produce_c0048_r0001_mt5_logic_parity_evidence",
        "active_run": "campaigns/C0048_intraday_range_energy_absorption_discovery/runs/R0001",
        ...
        "proxy_profit_factor": required.get("proxy_profit_factor") if isinstance(required, dict) else None,
        "next_required_action": "produce_c0048_r0001_mt5_logic_parity_evidence",
        "note": "C0048 R0001 proxy evidence recorded; MT5 paired validation remains mandatory regardless of proxy result.",
...
def replace_run_markers(value: Any) -> Any:
    ...
    if isinstance(value, str):
        replacements = {
            "C0004": "C0048",
            "c0004_r0001_fold_local_state_archetype": "c0048_r0001_intraday_range_energy_absorption",
            "c0004_r0001": "c0048_r0001",
            ...
            "state_archetype_summary": "intraday_range_energy_absorption_summary",
        }
