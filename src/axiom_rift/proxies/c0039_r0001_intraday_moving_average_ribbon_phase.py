"""C0039 R0001 proxy evidence for intraday moving average ribbon phase discovery."""
...
RUN_DIR = PROJECT_ROOT / "campaigns" / "C0039_intraday_moving_average_ribbon_phase_discovery" / "runs" / "R0001"
CAMPAIGN_PATH = PROJECT_ROOT / "campaigns" / "C0039_intraday_moving_average_ribbon_phase_discovery" / "campaign.yaml"
PROXY_PATH = RUN_DIR / "kpi" / "proxy.json"
TRADE_ARTIFACT_PATH = RUN_DIR / "artifacts" / "c0039_r0001_proxy_trades.csv"
MOVING_AVERAGE_RIBBON_PHASE_SUMMARY_PATH = RUN_DIR / "artifacts" / "c0039_r0001_moving_average_ribbon_phase_summary.json"
...
FEATURE_NAMES = (
    ...
    "ema_fast_displacement_8",
    "ema_mid_displacement_21",
    "ema_slow_displacement_55",
    "ribbon_stack_alignment",
    "ribbon_stack_opposition",
    "ribbon_width_atr",
    "ribbon_width_change_6",
    "ribbon_width_change_24",
    "ribbon_slope_fast_6",
    "ribbon_slope_fast_12",
    "ribbon_slope_mid_12",
    "ribbon_slope_mid_24",
    "ribbon_slope_slow_24",
    "slope_consensus",
    "slope_inflection_12",
    "price_above_ribbon_fraction_24",
    "price_below_ribbon_fraction_24",
    "pullback_to_fast_ema_depth",
    "pullback_to_mid_ema_depth",
    "ribbon_retest_recency_24",
    "ribbon_retest_acceptance_12",
    "ribbon_breach_pressure_12",
    "ribbon_breach_pressure_24",
    "ribbon_recapture_pressure_12",
    "ribbon_recapture_pressure_24",
    "ribbon_trend_age_48",
    "ribbon_phase_shift_24",
    "ribbon_compression_breakout_pressure",
    "ribbon_expansion_exhaustion_pressure",
    "body_ribbon_alignment_6",
    "body_ribbon_alignment_12",
    "wick_ribbon_rejection_6",
    "path_efficiency_12",
    "churn_ratio_12",
    "day_ribbon_displacement",
    "session_progress",
    "spread_over_range",
    "spread_ribbon_stress_24",
)
MODEL_FAMILY = "fold_local_intraday_moving_average_ribbon_phase_rank"
LABEL_SHAPE = "directional_intraday_moving_average_ribbon_phase_survival_quality"
POSITIVE_LABEL_THRESHOLD = 0.18
ADVERSE_LABEL_THRESHOLD = -0.36
FEATURE_WEIGHT_FLOOR = 0.25
FEATURE_WEIGHT_CEILING = 2.50
SELECTION_RULE = "top_fold_local_intraday_moving_average_ribbon_phase_scores_per_active_day"
...
def run_c0039_r0001_proxy(write: bool = True) -> dict[str, object]:
...
def build_proxy_run_result() -> base.ProxyRunResult:
    ...
    price_context = build_moving_average_ribbon_phase_context(bars, range_average, short_range_average, day_context)
    trades: list[base.Trade] = []
...
def build_candidates(
    ...
    for index in range(start_index, end_index + 1):
        ...
        for direction in (1, -1):
            features = intraday_moving_average_ribbon_phase_features(
                bars,
                range_average,
                short_range_average,
                day_context,
            ...
            if features is None:
                continue
            label = (
                intraday_moving_average_ribbon_phase_label(bars, range_average, price_context, index, direction)
                if include_labels
                else None
            )
            ...
            candidates.append(
                base.Candidate(
                    ...
                    state_key=f"{side}|intraday_moving_average_ribbon_phase",
                    features=features,
                    label=label,
                )
            )
...
def build_moving_average_ribbon_phase_context(
    bars: list[base.Bar],
    range_average: list[float | None],
    short_range_average: list[float | None],
    day_context: list[dict[str, float] | None],
...
def intraday_moving_average_ribbon_phase_features(
    bars: list[base.Bar],
    range_average: list[float | None],
    short_range_average: list[float | None],
    day_context: list[dict[str, float] | None],
    ...
    if len(features) != len(FEATURE_NAMES):
        raise RuntimeError(f"C0039 feature length mismatch: {len(features)} != {len(FEATURE_NAMES)}")
    return tuple(float(value) for value in features)


def intraday_moving_average_ribbon_phase_label(
    bars: list[base.Bar],
    range_average: list[float | None],
    ribbon_context: list[dict[str, float] | None],
    index: int,
    ...
    future_release = future_moving_average_ribbon_phase_retention(ribbon_context, entry_index, exit_index, direction)
...
def future_moving_average_ribbon_phase_retention(
    ribbon_context: list[dict[str, float] | None],
    entry_index: int,
    exit_index: int,
    direction: int,
...
def linear_model_summary(model: LinearEdgeModel) -> dict[str, object]:
    return {
        ...
        "score_interpretation": "higher_score_means_direct_fold_local_intraday_moving_average_ribbon_phase_rank",
    }
...
def build_proxy_payload(
    ...
    payload["campaign_id"] = "C0039"
    payload["work_unit_id"] = "C0039"
    payload["run_id"] = "R0001"
    payload["proxy_id"] = "PX-C0039-R0001"
    payload["proxy_engine"] = "axiom_rift.proxies.c0039_r0001_intraday_moving_average_ribbon_phase"
    payload["proxy_config_path"] = "campaigns/C0039_intraday_moving_average_ribbon_phase_discovery/runs/R0001/run_manifest.json"
    payload["split_policy"] = "rolling_window_test_oos_only_with_train_is_intraday_moving_average_ribbon_phase_rank_fit"
    payload["claim_boundary"] = dict(CLAIM_BOUNDARY)
    payload["proxy_artifact_paths"] = [
        "campaigns/C0039_intraday_moving_average_ribbon_phase_discovery/runs/R0001/kpi/proxy.json",
        "campaigns/C0039_intraday_moving_average_ribbon_phase_discovery/runs/R0001/artifacts/c0039_r0001_proxy_trades.csv",
        "campaigns/C0039_intraday_moving_average_ribbon_phase_discovery/runs/R0001/artifacts/c0039_r0001_moving_average_ribbon_phase_summary.json",
    ]
    ...
    profiles["intraday_moving_average_ribbon_phase_profile"] = {  # type: ignore[index]
        "applies": True,
        "fields": {
            "model_family": MODEL_FAMILY,
            "feature_count": len(FEATURE_NAMES),
    ...
    profiles["mt5_pairing_profile"] = {  # type: ignore[index]
        ...
        "fields": {
            ...
            "next_action": "produce_c0039_r0001_mt5_logic_parity_evidence",
        },
    }
    return payload
    ...
    config.update(
        {
            ...
            "score_interpretation": "higher_score_means_direct_fold_local_intraday_moving_average_ribbon_phase_rank",
            "variant_boundary": (
                "intraday_moving_average_ribbon_phase_rank_not_effort_absorption_seasonal_residual_tail_risk_skew_entropy_"
...
def write_proxy_evidence(payload: dict[str, object], trades: list[base.Trade]) -> None:
    ...
    write_moving_average_ribbon_phase_summary_artifact(payload, MOVING_AVERAGE_RIBBON_PHASE_SUMMARY_PATH)
    write_text_local(PROXY_PATH, json.dumps(payload, indent=2, sort_keys=True) + "\n")
    trade_hash = sha256_file_local(TRADE_ARTIFACT_PATH)
    summary_hash = sha256_file_local(MOVING_AVERAGE_RIBBON_PHASE_SUMMARY_PATH)
...
def write_moving_average_ribbon_phase_summary_artifact(payload: dict[str, object], path: Path) -> None:
    profiles = payload["conditional_profiles"]  # type: ignore[index]
    summary = {
        "schema": "axiom_rift_fold_local_intraday_moving_average_ribbon_phase_summary_v1",
        "template": False,
        "work_unit_id": "C0039",
        "campaign_id": "C0039",
        "run_id": "R0001",
        ...
        "intraday_moving_average_ribbon_phase_profile": profiles["intraday_moving_average_ribbon_phase_profile"]["fields"],  # type: ignore[index]
...
def update_artifact_lineage(proxy_hash: str, trade_hash: str, summary_hash: str) -> None:
    ...
    records = [
        ...
        if record.get("artifact_role") not in {"proxy_kpi", "proxy_trade_artifact", "intraday_moving_average_ribbon_phase_summary_artifact"}
    ]
    records.extend(
        [
            artifact_record(
                "A-C0039-R0001-PROXY-KPI",
                "proxy_kpi",
                "json",
                "campaigns/C0039_intraday_moving_average_ribbon_phase_discovery/runs/R0001/kpi/proxy.json",
                proxy_hash,
                [
                    ...
                    "campaigns/C0039_intraday_moving_average_ribbon_phase_discovery/runs/R0001/run_manifest.json",
                ],
            ),
            artifact_record(
                "A-C0039-R0001-PROXY-TRADES",
            ...
            artifact_record(
                "A-C0039-R0001-MOVING-AVERAGE-RIBBON-PHASE-SUMMARY",
                "intraday_moving_average_ribbon_phase_summary_artifact",
                "json",
                "campaigns/C0039_intraday_moving_average_ribbon_phase_discovery/runs/R0001/artifacts/c0039_r0001_moving_average_ribbon_phase_summary.json",
                summary_hash,
                ["campaigns/C0039_intraday_moving_average_ribbon_phase_discovery/runs/R0001/kpi/proxy.json"],
...
def artifact_record(
    ...
    return {
        ...
        "sha256": digest,
        "produced_by": "axiom_rift.proxies.c0039_r0001_intraday_moving_average_ribbon_phase",
...
def update_run_manifest_status() -> None:
    ...
    evidence["proxy_trade_artifact"] = "artifacts/c0039_r0001_proxy_trades.csv"
    evidence["intraday_moving_average_ribbon_phase_summary"] = "artifacts/c0039_r0001_moving_average_ribbon_phase_summary.json"
...
def update_gate_report() -> None:
    ...
    data["next_action"] = "produce_c0039_r0001_mt5_logic_parity_evidence"
    evidence_paths = list(data.get("evidence_paths") or [])
    for path in (
        "artifacts/c0039_r0001_proxy_trades.csv",
        "artifacts/c0039_r0001_moving_average_ribbon_phase_summary.json",
        "kpi/proxy.json",
    ):
    ...
    data["deferred_with_reason"] = [
        {
            ...
            "revisit_when": "after C0039 R0001 MT5 evidence files contain measured results",
        }
    ]
...
def update_campaign_status() -> None:
    ...
    next_candidate["direction"] = "active_c0039_r0001_mt5_logic_parity"
    ...
    closeout["remaining_question"] = "produce_c0039_r0001_mt5_logic_parity_evidence"
...
def update_reentry_after_proxy() -> None:
    ...
    data["project"]["active_campaign"] = "campaigns/C0039_intraday_moving_average_ribbon_phase_discovery"
    data["project"]["active_run"] = "campaigns/C0039_intraday_moving_average_ribbon_phase_discovery/runs/R0001"
    next_work = data.setdefault("next_work", {})
    next_work["campaign"] = "campaigns/C0039_intraday_moving_average_ribbon_phase_discovery"
    completed = list(next_work.get("completed") or [])
    for item in (
        "open_c0039_intraday_moving_average_ribbon_phase_discovery",
        "open_c0039_r0001_fold_local_intraday_moving_average_ribbon_phase_rank_run",
        "produce_c0039_r0001_proxy_evidence",
    ):
    ...
    data["active_campaign"] = "campaigns/C0039_intraday_moving_average_ribbon_phase_discovery"
    data["active_run"] = "campaigns/C0039_intraday_moving_average_ribbon_phase_discovery/runs/R0001"
...
def update_claim_state_after_proxy(payload: dict[str, object]) -> None:
    ...
    data["latest_operation"] = {
        "id": "produce_c0039_r0001_proxy_evidence",
        "status": "completed",
        "recorded_at_source": "campaigns/C0039_intraday_moving_average_ribbon_phase_discovery/runs/R0001/kpi/proxy.json",
        ...
        "next_required_action": "produce_c0039_r0001_mt5_logic_parity_evidence",
...
def update_decision_cursor_after_proxy(payload: dict[str, object]) -> None:
    ...
    data["canonical_source"] = "campaigns/C0039_intraday_moving_average_ribbon_phase_discovery/runs/R0001/kpi/proxy.json"
    data["canonical_status"] = "proxy_recorded_pending_mt5"
    data["current_decision"] = "produce_c0039_r0001_mt5_logic_parity_evidence"
    data["active_campaign"] = "campaigns/C0039_intraday_moving_average_ribbon_phase_discovery"
    data["active_run"] = "campaigns/C0039_intraday_moving_average_ribbon_phase_discovery/runs/R0001"
    data["next_required_action"] = "produce_c0039_r0001_mt5_logic_parity_evidence"
    data["current_evidence_summary"] = {
        "source_campaign": "campaigns/C0039_intraday_moving_average_ribbon_phase_discovery",
        "current_task": "produce_c0039_r0001_mt5_logic_parity_evidence",
        "active_run": "campaigns/C0039_intraday_moving_average_ribbon_phase_discovery/runs/R0001",
        "active_run_status": "proxy_recorded_pending_mt5",
        "evidence_status": "proxy_recorded_pending_mt5",
        "campaign_family": "intraday_moving_average_ribbon_phase",
        "entries_per_active_day": summary.get("entries_per_active_day") if isinstance(summary, dict) else None,
        "proxy_trade_count": required.get("proxy_trade_count") if isinstance(required, dict) else None,
        "proxy_net_pnl_points": required.get("proxy_net_pnl_points") if isinstance(required, dict) else None,
        "proxy_profit_factor": required.get("proxy_profit_factor") if isinstance(required, dict) else None,
        "next_required_action": "produce_c0039_r0001_mt5_logic_parity_evidence",
        "note": "C0039 R0001 proxy evidence recorded; MT5 paired validation remains mandatory regardless of proxy result.",
        "source_campaign_manifest": "campaigns/C0039_intraday_moving_average_ribbon_phase_discovery/campaign.yaml",
    }
...
def replace_run_markers(value: Any) -> Any:
    ...
    if isinstance(value, str):
        replacements = {
            "C0004": "C0039",
            "c0004_r0001_fold_local_state_archetype": "c0039_r0001_intraday_moving_average_ribbon_phase",
            "c0004_r0001": "c0039_r0001",
            "fold_local_state_archetype_discovery": "intraday_moving_average_ribbon_phase_discovery",
            ...
            "state_archetype_summary": "intraday_moving_average_ribbon_phase_summary",
        }
