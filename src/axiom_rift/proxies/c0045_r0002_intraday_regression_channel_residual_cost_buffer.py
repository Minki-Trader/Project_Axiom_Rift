"""C0045 R0002 proxy evidence for intraday regression channel residual discovery."""
...
RUN_DIR = PROJECT_ROOT / "campaigns" / "C0045_intraday_regression_channel_residual_discovery" / "runs" / "R0002"
...
TRADE_ARTIFACT_PATH = RUN_DIR / "artifacts" / "c0045_r0002_proxy_trades.csv"
REGRESSION_CHANNEL_RESIDUAL_SUMMARY_PATH = RUN_DIR / "artifacts" / "c0045_r0002_regression_channel_residual_summary.json"
...
MODEL_FAMILY = "fold_local_intraday_regression_channel_residual_directional_cost_buffer_rank"
LABEL_SHAPE = "directional_cost_buffered_intraday_regression_channel_residual_survival_quality"
POSITIVE_LABEL_THRESHOLD = 0.18
ADVERSE_LABEL_THRESHOLD = -0.36
FEATURE_WEIGHT_FLOOR = 0.25
FEATURE_WEIGHT_CEILING = 2.50
SELECTION_RULE = "short_primary_cost_buffered_top_fold_local_intraday_regression_channel_residual_scores_per_active_day"
...
def run_c0045_r0002_proxy(write: bool = True) -> dict[str, object]:
        ...
        for direction in (-1,):
            ...
            candidates.append(
                base.Candidate(
                    ...
                    state_key=f"{side}|intraday_regression_channel_residual_cost_buffer",
                    features=features,
                    label=label,
                )
            )
...
def linear_model_summary(model: LinearEdgeModel) -> dict[str, object]:
    return {
        ...
        "score_interpretation": "higher_score_means_short_primary_cost_buffered_regression_channel_residual_rank",
    }
...
def build_proxy_payload(
    ...
    payload["proxy_id"] = "PX-C0045-R0002"
    payload["proxy_engine"] = "axiom_rift.proxies.c0045_r0002_intraday_regression_channel_residual_cost_buffer"
    payload["proxy_config_path"] = "campaigns/C0045_intraday_regression_channel_residual_discovery/runs/R0002/run_manifest.json"
    ...
    payload["proxy_artifact_paths"] = [
        "campaigns/C0045_intraday_regression_channel_residual_discovery/runs/R0002/kpi/proxy.json",
        "campaigns/C0045_intraday_regression_channel_residual_discovery/runs/R0002/artifacts/c0045_r0002_proxy_trades.csv",
        "campaigns/C0045_intraday_regression_channel_residual_discovery/runs/R0002/artifacts/c0045_r0002_regression_channel_residual_summary.json",
    ]
    ...
    profiles["intraday_regression_channel_residual_profile"] = {  # type: ignore[index]
        ...
        "fields": {
            ...
            "candidate_direction": "short_primary_only_after_r0001_long_weakness_evidence",
            "model_selected": False,
            "feature_set_selected": False,
            "label_selected": False,
        },
    ...
    profiles["mt5_pairing_profile"] = {  # type: ignore[index]
        ...
        "fields": {
            ...
            "next_action": "produce_c0045_r0002_mt5_logic_parity_evidence",
        },
    }
    return payload
    ...
    config.update(
        {
            ...
            "score_interpretation": "higher_score_means_short_primary_cost_buffered_regression_channel_residual_rank",
            "variant_boundary": (
                "short_primary_cost_buffered_intraday_regression_channel_residual_rank_not_selected_claim_not_"
                "synthetic_commission_not_threshold_stop_target_hold_session_activity_capital_or_retry_nudge"
            ),
        }
    )
    return config
        ...
        [
            artifact_record(
                ...
                [
                    ...
                    "campaigns/C0045_intraday_regression_channel_residual_discovery/runs/R0002/run_manifest.json",
                ],
            ),
            artifact_record(
                "A-C0045-R0002-PROXY-TRADES",
            ...
            artifact_record(
                "A-C0045-R0002-REGRESSION-CHANNEL-RESIDUAL-SUMMARY",
...
def artifact_record(
    ...
    return {
        ...
        "sha256": digest,
        "produced_by": "axiom_rift.proxies.c0045_r0002_intraday_regression_channel_residual_cost_buffer",
...
def update_run_manifest_status() -> None:
    ...
    evidence["proxy_trade_artifact"] = "artifacts/c0045_r0002_proxy_trades.csv"
    evidence["intraday_regression_channel_residual_summary"] = "artifacts/c0045_r0002_regression_channel_residual_summary.json"
...
def update_gate_report() -> None:
    ...
    data["next_action"] = "produce_c0045_r0002_mt5_logic_parity_evidence"
    evidence_paths = list(data.get("evidence_paths") or [])
    for path in (
        "artifacts/c0045_r0002_proxy_trades.csv",
        "artifacts/c0045_r0002_regression_channel_residual_summary.json",
        "kpi/proxy.json",
    ):
    ...
    data["deferred_with_reason"] = [
        {
            ...
            "revisit_when": "after C0045 R0002 MT5 evidence files contain measured results",
        }
    ]
...
def update_campaign_status() -> None:
    ...
    next_candidate["direction"] = "active_c0045_r0002_mt5_logic_parity"
    ...
    closeout["remaining_question"] = "produce_c0045_r0002_mt5_logic_parity_evidence"
...
def update_reentry_after_proxy() -> None:
    ...
    data["project"]["active_run"] = "campaigns/C0045_intraday_regression_channel_residual_discovery/runs/R0002"
    ...
    for item in (
        ...
        "open_c0045_r0002_fold_local_intraday_regression_channel_residual_rank_run",
        "produce_c0045_r0002_proxy_evidence",
    ):
    ...
    data["active_run"] = "campaigns/C0045_intraday_regression_channel_residual_discovery/runs/R0002"
...
def update_claim_state_after_proxy(payload: dict[str, object]) -> None:
    ...
    data["latest_operation"] = {
        "id": "produce_c0045_r0002_proxy_evidence",
        "status": "completed",
        "recorded_at_source": "campaigns/C0045_intraday_regression_channel_residual_discovery/runs/R0002/kpi/proxy.json",
        ...
        "next_required_action": "produce_c0045_r0002_mt5_logic_parity_evidence",
...
def update_decision_cursor_after_proxy(payload: dict[str, object]) -> None:
    ...
    data["canonical_source"] = "campaigns/C0045_intraday_regression_channel_residual_discovery/runs/R0002/kpi/proxy.json"
    data["canonical_status"] = "proxy_recorded_pending_mt5"
    data["current_decision"] = "produce_c0045_r0002_mt5_logic_parity_evidence"
    data["active_campaign"] = "campaigns/C0045_intraday_regression_channel_residual_discovery"
    data["active_run"] = "campaigns/C0045_intraday_regression_channel_residual_discovery/runs/R0002"
    data["next_required_action"] = "produce_c0045_r0002_mt5_logic_parity_evidence"
    data["current_evidence_summary"] = {
        "source_campaign": "campaigns/C0045_intraday_regression_channel_residual_discovery",
        "current_task": "produce_c0045_r0002_mt5_logic_parity_evidence",
        "active_run": "campaigns/C0045_intraday_regression_channel_residual_discovery/runs/R0002",
        ...
        "proxy_profit_factor": required.get("proxy_profit_factor") if isinstance(required, dict) else None,
        "next_required_action": "produce_c0045_r0002_mt5_logic_parity_evidence",
        "note": "C0045 R0002 proxy evidence recorded; MT5 paired validation remains mandatory regardless of proxy result.",
...
def replace_run_markers(value: Any) -> Any:
    ...
    if isinstance(value, str):
        replacements = {
            "C0004": "C0045",
            "c0004_r0001_fold_local_state_archetype": "c0045_r0002_intraday_regression_channel_residual_cost_buffer",
            "c0004_r0001": "c0045_r0002",
