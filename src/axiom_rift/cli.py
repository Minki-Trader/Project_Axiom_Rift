...
RUN_SPECS: tuple[RunSpec, ...] = (
    ...
    RunSpec(
        "c0128_r0001",
        "axiom_rift.mt5.c0128_r0001_probe",
        "axiom_rift.proxies.c0128_r0001_intraday_close_location_torque_reversal",
    ),
    RunSpec(
        "c0129_r0001",
        "axiom_rift.mt5.c0129_r0001_probe",
        "axiom_rift.proxies.c0129_r0001_intraday_directional_curvature_continuation",
    ),
    RunSpec(
        "c0130_r0001",
        "axiom_rift.mt5.c0130_r0001_probe",
        "axiom_rift.proxies.c0130_r0001_intraday_session_skew_normalization_reversal",
    ),
    RunSpec(
        "c0131_r0001",
        "axiom_rift.mt5.c0131_r0001_probe",
        "axiom_rift.proxies.c0131_r0001_intraday_bar_sequence_alternation_pressure_release",
    ),
    RunSpec(
        "c0132_r0001",
        "axiom_rift.mt5.c0132_r0001_probe",
        "axiom_rift.proxies.c0132_r0001_intraday_inside_outside_bar_expansion",
    ),
    RunSpec(
        "c0133_r0001",
        "axiom_rift.mt5.c0133_r0001_probe",
        "axiom_rift.proxies.c0133_r0001_intraday_failed_extreme_continuation_absorption",
    ),
    RunSpec(
        "c0134_r0001",
        "axiom_rift.mt5.c0134_r0001_probe",
        "axiom_rift.proxies.c0134_r0001_intraday_adverse_excursion_compression_continuation",
    ),
    RunSpec(
        "c0135_r0001",
        "axiom_rift.mt5.c0135_r0001_probe",
        "axiom_rift.proxies.c0135_r0001_intraday_vwap_acceptance_continuation",
    ),
    RunSpec(
        "c0136_r0001",
        "axiom_rift.mt5.c0136_r0001_probe",
        "axiom_rift.proxies.c0136_r0001_intraday_swing_pivot_retest_continuation",
    ),
    RunSpec(
        "c0137_r0001",
        "axiom_rift.mt5.c0137_r0001_probe",
        "axiom_rift.proxies.c0137_r0001_intraday_session_extreme_failure_acceptance_reversal",
    ),
    RunSpec(
        "c0138_r0001",
        "axiom_rift.mt5.c0138_r0001_probe",
        "axiom_rift.proxies.c0138_r0001_intraday_tempo_contraction_acceleration_continuation",
    ),
    RunSpec(
        "c0139_r0001",
        "axiom_rift.mt5.c0139_r0001_probe",
        "axiom_rift.proxies.c0139_r0001_intraday_liquidity_drought_recoil_continuation",
    ),
    RunSpec(
        "c0140_r0001",
        "axiom_rift.mt5.c0140_r0001_probe",
        "axiom_rift.proxies.c0140_r0001_intraday_anchor_braid_squeeze_escape_continuation",
    ),
    RunSpec(
        "c0141_r0001",
        "axiom_rift.mt5.c0141_r0001_probe",
        "axiom_rift.proxies.c0141_r0001_intraday_range_overextension_snapback_reversal",
    ),
    RunSpec(
        "c0142_r0001",
        "axiom_rift.mt5.c0142_r0001_probe",
        "axiom_rift.proxies.c0142_r0001_intraday_two_sided_auction_release_continuation",
    ),
    RunSpec(
        "c0143_r0001",
        "axiom_rift.mt5.c0143_r0001_probe",
        "axiom_rift.proxies.c0143_r0001_intraday_value_migration_pullback_continuation",
    ),
)
