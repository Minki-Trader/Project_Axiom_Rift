"""MT5 schedule-replay helpers for C0082 R0002."""
...
from axiom_rift.proxies.c0082_r0002_cost_slippage_portability_hardening import (
    BASE_FRAME,
    ROLLING_WINDOWS,
    SplitWindow,
    Trade,
...
CAMPAIGN_ID = "C0082"
RUN_ID = "R0002"
CAMPAIGN_ROOT = PROJECT_ROOT / "campaigns" / "C0082_intraday_midpoint_rotation_rejection_discovery"
...
SCHEDULE_ARTIFACT = RUN_ARTIFACT_DIR / "c0082_r0002_schedule.csv"
SCHEDULE_COMMON_REL = "AxiomRift\\C0082\\R0002\\schedule\\c0082_r0002_schedule.csv"
STARTING_BALANCE_USD = starting_balance_usd()
LOGIC_PARITY_STARTING_BALANCE_USD = 100000.0
RESPONSE_MODE = "fold_local_intraday_midpoint_rotation_rejection_schedule_replay"
MAX_HOLD_BARS = 10
MAGIC = 1082002
...
RUN_REL = f"{WORK_UNIT_REL}/runs/R0002"
NEXT_MAJOR_ACTION = "choose_c0083_new_major_hypothesis_after_c0082_closeout"
PREVIOUS_CAMPAIGN_REL = "campaigns/C0081_intraday_failed_acceleration_absorption_discovery"
C0082_CLOSE_REASON = (
...
def compile_c0082_r0002_ea(metaeditor_exe: Path | None = None) -> CompileResult:
    ...
    log = PROJECT_ROOT / "artifacts" / "reports" / "c0082_r0002_mt5_compile.log"
...
def tester_config_path_for_mode(mode: str, output_scope: str | None = None) -> Path:
    return PROJECT_ROOT / "artifacts" / "reports" / "c0082_r0002_mt5_tester" / f"c0082_r0002_{scoped_name(mode, output_scope)}_tester.ini"


def tester_report_path_for_mode(mode: str, output_scope: str | None = None) -> Path:
    return PROJECT_ROOT / "artifacts" / "reports" / "c0082_r0002_mt5_tester" / f"c0082_r0002_mt5_{scoped_name(mode, output_scope)}_report.htm"
...
def write_tester_config(
    ...
    config_dir = PROJECT_ROOT / "artifacts" / "reports" / "c0082_r0002_mt5_tester"
    ...
    if write_kpi:
        ...
        if mode == LOGIC_PARITY_MODE:
            upsert_artifact_lineage(
                "A-C0082-R0002-MT5-SCHEDULE",
                "mt5_schedule_csv",
                "mt5_logic_parity_input",
                rel(SCHEDULE_ARTIFACT),
                sha256_file(SCHEDULE_ARTIFACT),
                ["campaigns/C0082_intraday_midpoint_rotation_rejection_discovery/runs/R0002/kpi/proxy.json"],
            )
            upsert_artifact_lineage(
                "A-C0082-R0002-MT5-LOGIC-KPI",
                "mt5_logic_parity_kpi",
                "mt5_logic_parity",
                rel(MT5_LOGIC_KPI),
                sha256_file(MT5_LOGIC_KPI),
                [
                    "campaigns/C0082_intraday_midpoint_rotation_rejection_discovery/runs/R0002/artifacts/c0082_r0002_schedule.csv",
                    "configs/market.yaml",
                ],
            )
        else:
            upsert_artifact_lineage(
                "A-C0082-R0002-MT5-TICK-KPI",
                "mt5_tick_kpi",
                "mt5_tick",
                rel(MT5_TICK_KPI),
    ...
    return {
        ...
        **runtime_payload_fields(),
        ...
        "conditional_profiles": {
            ...
            "intraday_midpoint_rotation_rejection_schedule_profile": {
                "applies": True,
                "fields": {
                    "intraday_midpoint_rotation_rejection_source": "rolling_train_is_proxy_schedule",
        ...
        "deferred_with_reason": [
            {
                "field": "native_mql_or_onnx_intraday_midpoint_rotation_rejection_surface",
...
def record_c0082_r0002_parity() -> dict[str, object]:
    ...
    next_action = "produce_c0082_r0002_mt5_tick_execution_evidence" if mechanical_ok else "repair_c0082_r0002_schedule_replay_parity"
    ...
    payload = {
        ...
        "mechanical_checks": {
            ...
            "intraday_midpoint_rotation_rejection_schedule_match": "passed" if entry_compare["key_match_rate"] == 1.0 else "failed",
        ...
        "conditional_profiles": {
            ...
            "intraday_midpoint_rotation_rejection_schedule_replay_profile": {
                "applies": True,
                "fields": {
                    "schedule_artifact_path": rel(SCHEDULE_ARTIFACT),
                    "schedule_hash": sha256_file(SCHEDULE_ARTIFACT) if SCHEDULE_ARTIFACT.exists() else None,
                    "logic_boundary": "proxy_selected_fold_local_intraday_midpoint_rotation_rejection_schedule_replayed_in_mt5_closed_bar_mode",
        ...
        "deferred_with_reason": [
            {
                ...
                "requirement_class": "deferred_with_reason",
                "reason": "logic parity uses schedule replay only; native intraday midpoint rotation rejection materialization is deferred until candidate quality exists",
                "blocking_condition": "C0082 R0002 does not yet have fold-isolated tick evidence",
    ...
    upsert_artifact_lineage(
        "A-C0082-R0002-PROXY-VS-MT5-LOGIC-KPI",
        ...
        [
            "campaigns/C0082_intraday_midpoint_rotation_rejection_discovery/runs/R0002/kpi/proxy.json",
            "campaigns/C0082_intraday_midpoint_rotation_rejection_discovery/runs/R0002/kpi/mt5_logic_parity.json",
        ],
    )
...
def record_c0082_r0002_execution_divergence() -> dict[str, object]:
        ...
        "deferred_with_reason": [
            {
                ...
                "next_action": "produce_c0082_r0002_fold_isolated_mt5_tick_kpi",
            }
        ],
        "claim_boundary": {
            "claim_authority": False,
    ...
    upsert_artifact_lineage(
        "A-C0082-R0002-EXECUTION-DIVERGENCE-KPI",
        "diagnostic_output",
        ...
        [
            "campaigns/C0082_intraday_midpoint_rotation_rejection_discovery/runs/R0002/kpi/mt5_logic_parity.json",
            "campaigns/C0082_intraday_midpoint_rotation_rejection_discovery/runs/R0002/kpi/mt5_tick.json",
        ],
    )
...
def run_c0082_r0002_mt5_logic_workflow(timeout_seconds: int = 1800) -> dict[str, object]:
    result = run_c0082_r0002_tester(mode=LOGIC_PARITY_MODE, timeout_seconds=timeout_seconds)
    mt5_payload = parse_c0082_r0002_mt5(result)
    parity_payload = record_c0082_r0002_parity()
    return {
...
def run_c0082_r0002_mt5_tick_workflow(timeout_seconds: int = 1800) -> dict[str, object]:
    result = run_c0082_r0002_tester(mode=TICK_EXECUTION_MODE, timeout_seconds=timeout_seconds)
    mt5_payload = parse_c0082_r0002_mt5(result)
    divergence_payload = record_c0082_r0002_execution_divergence()
    return {
...
def run_c0082_r0002_mt5_tick_by_fold_workflow(timeout_seconds: int = 1800) -> dict[str, object]:
    compile_c0082_r0002_ea()
    write_schedule_files()
    records: list[dict[str, Any]] = []
    for window in load_test_windows():
        from_date, to_date = tester_dates_for_window(window)
        logic_result = run_c0082_r0002_tester(
        ...
        logic_payload = parse_c0082_r0002_mt5(logic_result, write_kpi=False)
        tick_result = run_c0082_r0002_tester(
        ...
        tick_payload = parse_c0082_r0002_mt5(tick_result, write_kpi=False)
        records.append(
            {
                "window": window,
                "from_date": from_date,
    ...
    upsert_artifact_lineage(
        "A-C0082-R0002-MT5-TICK-BY-FOLD-KPI",
    ...
    upsert_artifact_lineage(
        "A-C0082-R0002-EXECUTION-DIVERGENCE-BY-FOLD-KPI",
        "diagnostic_output",
        "execution_divergence_by_fold",
        rel(EXECUTION_DIVERGENCE_BY_FOLD_KPI),
        sha256_file(EXECUTION_DIVERGENCE_BY_FOLD_KPI),
        [
            "campaigns/C0082_intraday_midpoint_rotation_rejection_discovery/runs/R0002/kpi/mt5_tick_by_fold.json",
            "registries/rolling_windows.yaml",
        ],
    )
...
def build_mt5_tick_by_fold_payload(records: list[dict[str, Any]]) -> dict[str, object]:
    ...
    return {
        ...
        "synthesis_id_when_applicable": None,
        "run_id": RUN_ID,
        "mt5_probe_id": "MT5-C0082-R0002-BY-FOLD",
...
def build_execution_divergence_by_fold_payload(records: list[dict[str, Any]]) -> dict[str, object]:
    ...
    return {
        ...
        "synthesis_id_when_applicable": None,
        "run_id": RUN_ID,
        "divergence_id": "ED-C0082-R0002-BY-FOLD",
        "split_policy": "rolling_window_test_oos_fold_isolated",
        "split_registry": "registries/rolling_windows.yaml",
...
def update_after_fold_isolated(tick_payload: dict[str, object], divergence_payload: dict[str, object]) -> None:
    next_action = "review_c0082_r0002_tick_execution_kpi_and_closeout"
    ...
    gate["deferred_with_reason"] = [
        {
            ...
            "revisit_when": "during C0082 R0002 closeout review",
        }
    ]
    ...
    for item in (
        "produce_c0082_r0002_mt5_tick_execution_evidence",
        "record_c0082_r0002_execution_divergence",
        "produce_c0082_r0002_fold_isolated_mt5_tick_kpi",
        "produce_c0082_r0002_fold_isolated_execution_divergence",
    ):
        if item not in completed:
            completed.append(item)
    next_work["completed"] = [item for item in completed if item != next_action]
    next_work["tasks"] = [next_action]
    data["active_run"] = "campaigns/C0082_intraday_midpoint_rotation_rejection_discovery/runs/R0002"
    ...
    update_claim_state(
        operation_id="produce_c0082_r0002_fold_isolated_execution_divergence",
        source="campaigns/C0082_intraday_midpoint_rotation_rejection_discovery/runs/R0002/kpi/execution_divergence_by_fold.json",
...
def update_run_after_mt5(mode: str) -> None:
    ...
    evidence["mt5_schedule_artifact"] = "artifacts/c0082_r0002_schedule.csv"
    if mode == LOGIC_PARITY_MODE:
...
def update_after_parity(payload: dict[str, object], next_action: str) -> None:
    ...
    update_campaign_next(next_action)
    update_reentry_next("record_c0082_r0002_proxy_vs_mt5_logic_parity_evidence", next_action)
    update_claim_state(
        operation_id="record_c0082_r0002_proxy_vs_mt5_logic_parity_evidence",
        source="campaigns/C0082_intraday_midpoint_rotation_rejection_discovery/runs/R0002/kpi/proxy_vs_mt5_logic_parity.json",
...
def update_after_execution_divergence(payload: dict[str, object]) -> None:
    ...
    update_campaign_next(next_action)
    update_reentry_next("record_c0082_r0002_execution_divergence", next_action)
    update_claim_state(
        operation_id="record_c0082_r0002_execution_divergence",
        source="campaigns/C0082_intraday_midpoint_rotation_rejection_discovery/runs/R0002/kpi/execution_divergence.json",
...
def update_gate_next(status: str, next_action: str) -> None:
    ...
    for path in (
        ...
        "kpi/mt5_tick.json",
        "kpi/execution_divergence.json",
        "artifacts/c0082_r0002_schedule.csv",
    ):
        if path not in paths:
            paths.append(path)
    ...
    data["deferred_with_reason"] = [
        {
            ...
            "blocking_condition": "R0002 cannot close until MT5 tick, execution divergence, and fold-isolated evidence are recorded",
            "revisit_when": "after C0082 R0002 fold-isolated MT5 evidence files contain measured results",
        }
    ]
...
def update_campaign_next(next_action: str) -> None:
    ...
    next_candidate["reason"] = "R0002 remains open; mandatory MT5 paired validation is not complete."
...
def update_reentry_next(completed_item: str, next_action: str) -> None:
    ...
    next_work = data.setdefault("next_work", {})
    completed = list(next_work.get("completed") or [])
    for item in ("produce_c0082_r0002_proxy_evidence", completed_item):
        if item not in completed:
            completed.append(item)
...
def update_claim_state(operation_id: str, source: str, evidence_status: str, next_action: str, extra: dict[str, object]) -> None:
    ...
    data["active_campaign"] = "campaigns/C0082_intraday_midpoint_rotation_rejection_discovery"
    data["active_run"] = "campaigns/C0082_intraday_midpoint_rotation_rejection_discovery/runs/R0002"
    latest = {
        "id": operation_id,
        "status": "completed",
...
def C0082_closeout_kpi_summary() -> dict[str, Any]:
    ...
    return {
        ...
        "remaining_work_classification": (
            "no_candidate; further C0082 work would be adjacent threshold, stop, target, hold, session, "
            "activity, spread, capital, or midpoint-rotation-rejection feature nudge tuning"
        ),
    }


def C0082_negative_memory_asset(summary: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "onnx_ready": False,
        "hypothesis_tested": (
            "fold-local intraday midpoint rotation rejection rank over midpoint distance pressure, "
            "failed midpoint cross depth, rotation compression ratio, midpoint rejection wick, "
            "close escape strength, range balance skew, volume reengagement, prior-day midpoint context, "
            "session escape pressure, "
            "and spread stress features"
        ),
        "evidence_paths": closeout_evidence_paths(),
        "reason_not_candidate": (
            "activity landed inside the target band, but proxy, closed-bar MT5 logic, aggregate MT5 tick, "
            "and fold-isolated MT5 tick evidence did not establish a candidate"
        ),
        "next_boundary": (
            "C0082 R0002 shows the tested midpoint rotation rejection surface is not a candidate as implemented; "
            "remaining C0082 variants would be adjacent tuning, so next work should choose a new major C0083 "
        ...
        "supporting_lessons": [
            {
                ...
                "summary": (
                    f"R0002 produced {summary.get('profitable_fold_count')} profitable and "
            ...
            },
            {
                ...
                "summary": (
                    "Tick execution improved closed-bar logic by "
                    f"{summary.get('total_tick_minus_logic_net_pnl')} total net PnL across "
                    f"{summary.get('tick_better_fold_count')} better and "
                    f"{summary.get('tick_worse_fold_count')} worse folds, but both logic and tick surfaces "
                    "remained negative."
                ),
            },
            {
...
def C0082_closeout_review(closed_at: str) -> dict[str, Any]:
    summary = C0082_closeout_kpi_summary()
    return {
        "status": "closed_no_candidate",
        "basis": "rolling_window_fold_isolated_mt5_tick_and_execution_divergence",
        "close_reason": C0082_CLOSE_REASON,
        "closed_at_utc": closed_at,
        "required_kpi_summary": summary,
        "negative_memory": C0082_negative_memory_asset(summary),
    ...
    evidence.update(
        {
            ...
            "proxy_trade_artifact": "artifacts/c0082_r0002_proxy_trades.csv",
            "cost_slippage_portability_summary": "artifacts/c0082_r0002_cost_slippage_portability_summary.json",
            "mt5_schedule_artifact": "artifacts/c0082_r0002_schedule.csv",
...
def update_gate_report_for_closeout(closeout_review: dict[str, Any]) -> None:
    ...
    data["gate_report_id"] = "G-C0082-R0002"
    data["status"] = "closed_no_candidate"
...
def update_selected_for_closeout(closeout_review: dict[str, Any]) -> None:
    ...
    data["selected_reason"] = (
        "C0082 R0002 closed as no candidate: target-band activity was present, but proxy, MT5 logic, "
    ...
    data["latest_run_state"] = {
        "status": "closed_no_candidate",
        "source": "runs/R0002/gate_report.json",
    ...
    data["negative_memory"] = {
        "latest_run": "runs/R0002",
        "status": "recorded",
        "evidence_path": "runs/R0002/gate_report.json",
...
def update_campaign_for_closeout(closeout_review: dict[str, Any], closed_at: str) -> None:
    ...
    if "runs/R0002" not in closed_runs:
        closed_runs.append("runs/R0002")
    run_index["closed_runs"] = closed_runs
    run_index["next_run_candidate"] = {
        "run_id": None,
        "direction": NEXT_MAJOR_ACTION,
        "reason": (
            "C0082 R0002 closed no-candidate after proxy, MT5 logic parity, MT5 tick, execution divergence, "
            "and fold-isolated MT5 evidence. Further work inside C0082 would be adjacent tuning."
        ),
    ...
    data["synthesis_readiness"] = {
        ...
        "usable_ingredient_group_count": 21,
        "readiness_notes": [
            "C0049, C0050, C0051, C0052, C0053, C0054, C0055, C0056, C0057, C0058, C0059, C0060, C0061, C0062, C0063, C0064, C0065, C0066, C0070, C0071, C0072, C0073, and C0082 provide post-SC0009 negative-memory ingredients, but default usable ingredient minimums are not met.",
            "Next work can remain a new major campaign hypothesis, not C0082 threshold or stop/target tuning.",
        ],
    }
    data["closeout"] = {
        "status": "closed_no_candidate",
...
def update_reentry_for_closeout() -> None:
    ...
    for item in (
        ...
        "produce_c0082_r0002_fold_isolated_mt5_tick_kpi",
        "produce_c0082_r0002_fold_isolated_execution_divergence",
        "review_c0082_r0002_tick_execution_kpi_and_closeout",
        "close_c0082_r0002_no_candidate",
        "close_c0082_no_candidate_after_r0002",
    ):
        if item not in completed:
            completed.append(item)
...
def update_claim_state_for_closeout(closeout_review: dict[str, Any]) -> None:
    ...
    data["latest_operation"] = {
        "id": "close_c0082_r0002_no_candidate",
        "status": "completed",
...
def update_decision_cursor_for_closeout(closeout_review: dict[str, Any]) -> None:
    ...
    repo_scope["note"] = (
        ...
        "current_c0082_r0002_closeout_makes_no_selection_promotion_handoff_or_reproducibility_claims"
    )
    for item in repo_scope.get("nonblocking_debts") or []:
        if isinstance(item, dict):
            item["role"] = "repo_state_debt_not_current_c0082_r0002_closeout"
    ...
    current.update(
        {
            ...
            "next_required_action": NEXT_MAJOR_ACTION,
            "note": (
            "C0082 R0002 and C0082 closed no-candidate; midpoint rotation rejection surface produced "
                "target-band activity but did not establish candidate-quality fold-isolated MT5 evidence."
            ),
        }
    )
    data["next_decision_basis"] = [
        {
            ...
            "summary": "C0082 R0002 closed no-candidate with negative memory recorded.",
        },
        {
        ...
        },
        {
            ...
            "summary": "C0082 closed no-candidate; next work is a new major C0083 hypothesis.",
        },
    ]
...
def append_decision_registry_for_closeout(closeout_review: dict[str, Any]) -> None:
    ...
    if "dec_20260707_close_c0082_r0002_no_candidate" not in existing:
        decisions.append(
            {
                "decision_id": "dec_20260707_close_c0082_r0002_no_candidate",
                "created_local_date": local_date,
                "status": "active",
                "decision": "close_c0082_r0002_no_candidate",
                "refines": [
                    "dec_20260707_produce_c0082_r0002_proxy_evidence",
                    "dec_20260701_mandatory_mt5_paired_run_validation",
                ],
                "rationale": [
                    "c0082_r0002_completed_proxy_mt5_logic_parity_proxy_vs_mt5_parity_mt5_tick_execution_divergence_and_fold_isolated_tick_and_divergence_evidence",
    ...
    if "dec_20260707_close_c0082_no_candidate_after_r0002" not in existing:
        decisions.append(
            {
                "decision_id": "dec_20260707_close_c0082_no_candidate_after_r0002",
                "created_local_date": local_date,
                "status": "active",
                "decision": "close_c0082_no_candidate_after_r0002",
                "refines": [
                    "dec_20260707_close_c0082_r0002_no_candidate",
                    "dec_20260707_open_c0082_intraday_midpoint_rotation_rejection_discovery",
                ],
                "rationale": [
                    "C0082_boundary_was_answered_by_r0002_fold_isolated_mt5_evidence",
                    "remaining_C0082_work_would_be_adjacent_threshold_window_stop_target_hold_session_activity_spread_capital_or_feature_nudge_tuning",
                    "synthesis_readiness_candidate_later_because_post_sc0009_usable_ingredient_count_is_below_default_minimum",
                    "next_work_is_choose_c0083_new_major_hypothesis_after_c0082_closeout",
                    "no_selected_economics_runtime_materialization_onnx_promotion_or_live_claim_is_created",
                ],
                "claim_boundary": claim_boundary_payload(),
            }
...
def close_c0082_r0002_no_candidate() -> dict[str, object]:
    closed_at = utc_now()
    closeout_review = C0082_closeout_review(closed_at)
...
def C0082_candidate_evidence_asset(summary: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "onnx_ready": False,
        "hypothesis_tested": (
            "cost/slippage portability hardening overlay for fold-local intraday midpoint rotation "
            "rejection candidate evidence"
        ),
        "evidence_paths": closeout_evidence_paths(),
        "reason_retained": (
            f"R0002 retained target-band activity with {summary.get('entries_per_active_day')} entries per "
        ...
        "reason_not_selected": (
            "profit factor remains modest, 3 folds are losing, tick execution is worse than closed-bar logic "
            "in 7 of 9 folds, native MQL signal materialization and ONNX are absent, final sizing is not "
            "frozen, and historical repo lineage debt blocks selected, promotion, handoff, and "
            "reproducibility claims"
        ),
        "next_boundary": (
            "C0082 should close with retained candidate evidence only. Further C0082 work would be adjacent "
            "threshold, stop/target, hold, session, activity, spread, capital, materialization, ONNX, or "
            "retry hardening rather than a new non-adjacent discovery run."
        ),
        "supporting_lessons": [
            {
                "asset_type": "candidate_evidence",
                ...
                "summary": (
                    f"R0002 produced {summary.get('profitable_fold_count')} profitable and "
                    f"{summary.get('losing_fold_count')} losing fold-isolated MT5 tick folds, total tick "
                    f"net PnL {summary.get('total_tick_net_pnl')}, and worst fold "
            ...
            },
            {
                ...
                "summary": (
                    "Schedule replay mechanical parity passed with mismatch_count "
                    f"{summary.get('mismatch_count')}; the retained evidence is not explained by "
                    "proxy-vs-MT5 logic mismatch."
                ),
            },
            {
                "asset_type": "execution_divergence_lesson",
                "source": "kpi/execution_divergence_by_fold.json",
                "summary": (
                    "Tick execution was worse than closed-bar logic by "
                    f"{summary.get('total_tick_minus_logic_net_pnl')} total net PnL across "
                    f"{summary.get('tick_worse_fold_count')} worse and "
                    f"{summary.get('tick_better_fold_count')} better folds."
                ),
            },
            {
                "asset_type": "evidence_gap",
                "source": "gate_report.json",
                "summary": (
                    "R0002 improved the retained candidate surface but still lacks selected-contract "
                    "authority, native signal materialization, ONNX, final sizing, and lineage-debt repair."
                ),
            },
        ],
    }
...
def C0082_candidate_closeout_review(closed_at: str) -> dict[str, Any]:
    summary = C0082_closeout_kpi_summary()
    summary["remaining_work_classification"] = (
        "candidate_evidence_retained_not_selected; C0082 R0002 improved cost/slippage portability "
        "versus R0001 but remains too fragile for selected, economics-pass, runtime, materialization, "
        "ONNX, promotion, handoff, reproducibility, or live-readiness claims"
    )
    return {
        "status": "closed_with_candidate_evidence",
        "basis": "rolling_window_fold_isolated_mt5_tick_and_execution_divergence",
        "close_reason": "candidate_evidence_retained_not_selected_after_cost_slippage_portability_hardening",
        "closed_at_utc": closed_at,
        "required_kpi_summary": summary,
        "candidate_evidence": C0082_candidate_evidence_asset(summary),
        "claim_boundary": claim_boundary_payload(),
    }
...
def update_selected_for_candidate_closeout(closeout_review: dict[str, Any]) -> None:
    ...
    data["selected"] = False
    data["selected_reason"] = (
        "C0082 R0002 retained useful cost/slippage portability candidate evidence, but it is not "
        "selected because fold distribution and execution divergence remain fragile."
    )
    data["next_required_action"] = NEXT_MAJOR_ACTION
    data["claim_boundary"] = claim_boundary_payload()
    data["latest_run_state"] = {
...
def update_campaign_for_candidate_closeout(closeout_review: dict[str, Any], closed_at: str) -> None:
    ...
    run_index["next_run_candidate"] = {
        ...
        "direction": NEXT_MAJOR_ACTION,
        "reason": (
            "R0001 and R0002 retained candidate evidence, but remaining C0082 work would be adjacent "
            "threshold, cost, materialization, ONNX, spread, capital, or retry hardening rather than a "
            "new non-adjacent run."
        ),
    ...
    data["synthesis_readiness"] = {
        ...
        "readiness_notes": [
            "c0082_r0001_candidate_evidence_retained_not_selected",
            "c0082_r0002_cost_slippage_portability_candidate_evidence_retained_not_selected",
    ...
    data["campaign_lessons"] = [
        "R0001 midpoint rotation rejection evidence remains useful candidate evidence but not selected.",
        "R0002 cost/slippage portability hardening improved the retained surface but kept 3 losing folds and tick-worse divergence in 7 folds.",
        "Further C0082 work would be adjacent hardening rather than a new non-adjacent run.",
    ]
    data["claim_boundary"] = claim_boundary_payload()
    CAMPAIGN.write_text(yaml.safe_dump(data, sort_keys=False, allow_unicode=False, width=88), encoding="ascii")


def update_reentry_for_candidate_closeout() -> None:
    data = yaml.safe_load(REENTRY.read_text(encoding="ascii"))
    data["updated_local_date"] = datetime.now().date().isoformat()
    ...
    for item in (
        ...
        "produce_c0082_r0002_mt5_logic_parity_evidence",
        "record_c0082_r0002_proxy_vs_mt5_logic_parity_evidence",
        "produce_c0082_r0002_mt5_tick_execution_evidence",
        "record_c0082_r0002_execution_divergence",
        "produce_c0082_r0002_fold_isolated_mt5_tick_kpi",
        "produce_c0082_r0002_fold_isolated_execution_divergence",
        "review_c0082_r0002_tick_execution_kpi_and_closeout",
        "close_c0082_r0002_with_candidate_evidence",
        "close_c0082_with_candidate_evidence_after_r0002",
    ):
        if item not in completed:
            completed.append(item)
    completed = [item for item in completed if item != NEXT_MAJOR_ACTION]
...
def update_claim_state_for_candidate_closeout(closeout_review: dict[str, Any]) -> None:
    ...
    data["active_run"] = None
    data["latest_operation"] = {
        "id": "close_c0082_r0002_with_candidate_evidence",
        "status": "completed",
        "recorded_at_source": f"{RUN_REL}/gate_report.json",
    ...
    current.update(
        {
            ...
            "losing_fold_count": summary.get("losing_fold_count"),
            "next_required_action": NEXT_MAJOR_ACTION,
            "note": "C0082 closed with retained candidate evidence, not selected or promoted.",
        }
    )
    data["next_decision_basis"] = [
        {
            "path": f"{RUN_REL}/gate_report.json",
            "role": "closed_run_gate_report",
            "summary": "C0082 R0002 closed with candidate evidence retained, not selected.",
        },
        {
            "path": f"{RUN_REL}/kpi/mt5_tick_by_fold.json",
            "role": "fold_isolated_mt5_tick_kpi",
            "summary": "Fold-isolated MT5 tick evidence completed with 6 profitable and 3 losing folds.",
        },
        {
            "path": f"{WORK_UNIT_REL}/campaign.yaml",
            "role": "closed_campaign_manifest",
            "summary": "C0082 closed with candidate evidence; next work is a new major C0083 hypothesis.",
        },
    ]
    data["claim_boundary_snapshot"] = claim_boundary_payload()
    DECISION_CURSOR.write_text(yaml.safe_dump(data, sort_keys=False, allow_unicode=False, width=88), encoding="ascii")
...
def append_decision_registry_for_candidate_closeout(closeout_review: dict[str, Any]) -> None:
    ...
    summary = closeout_review["required_kpi_summary"]
    local_date = datetime.now().date().isoformat()
    if "dec_20260707_close_c0082_r0002_with_candidate_evidence" not in existing:
        decisions.append(
            {
                "decision_id": "dec_20260707_close_c0082_r0002_with_candidate_evidence",
                "created_local_date": local_date,
                "status": "active",
                "decision": "close_c0082_r0002_with_candidate_evidence",
                "refines": [
                    "dec_20260707_produce_c0082_r0002_proxy_evidence",
                    "dec_20260701_mandatory_mt5_paired_run_validation",
                ],
    ...
    if "dec_20260707_close_c0082_with_candidate_evidence_after_r0002" not in existing:
        decisions.append(
            {
                "decision_id": "dec_20260707_close_c0082_with_candidate_evidence_after_r0002",
                "created_local_date": local_date,
                "status": "active",
                "decision": "close_c0082_with_candidate_evidence_after_r0002",
                "refines": [
                    "dec_20260707_close_c0082_r0002_with_candidate_evidence",
                    "dec_20260707_open_c0082_intraday_midpoint_rotation_rejection_discovery",
                ],
                "rationale": [
                    "C0082_R0001_and_R0002_retain_candidate_evidence_without_claim_authority",
                    "remaining_C0082_work_would_be_adjacent_threshold_window_stop_target_hold_session_activity_spread_capital_materialization_onnx_or_retry_hardening",
                    "next_work_is_choose_c0083_new_major_hypothesis_after_c0082_closeout",
                    "no_selected_economics_runtime_materialization_onnx_promotion_or_live_claim_is_created",
                ],
                "claim_boundary": claim_boundary_payload(),
...
def close_c0082_r0002_with_candidate_evidence() -> dict[str, object]:
    closed_at = utc_now()
    closeout_review = C0082_candidate_closeout_review(closed_at)
    ...
    update_reentry_for_candidate_closeout()
    ...
    records.append(
        {
            ...
            "sha256": digest,
            "produced_by": "axiom_rift.mt5.c0082_r0002_probe",
